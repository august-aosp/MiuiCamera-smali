...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput-object p1, p0, Lcom/android/camera/ThumbnailUpdater;->e:Landroid/content/ContentResolver;
    ...
    invoke-direct {p1, v0, p0}, Lcom/android/camera/ThumbnailUpdater$a;-><init>(Landroid/os/Handler;Ld/c/a/l5;)V

    iput-object p1, p0, Lcom/android/camera/ThumbnailUpdater;->g:Lcom/android/camera/ThumbnailUpdater$a;

    new-instance p1, Lcom/android/camera/ThumbnailUpdater$b;

    iget-object v0, p0, Lcom/android/camera/ThumbnailUpdater;->j:Landroid/os/Handler;

    invoke-direct {p1, v0, p0}, Lcom/android/camera/ThumbnailUpdater$b;-><init>(Landroid/os/Handler;Ld/c/a/l5;)V

    iput-object p1, p0, Lcom/android/camera/ThumbnailUpdater;->h:Lcom/android/camera/ThumbnailUpdater$b;

    iget-object p1, p0, Lcom/android/camera/ThumbnailUpdater;->j:Landroid/os/Handler;

    new-instance v0, Ld/c/a/i2;

    invoke-direct {v0, p0}, Ld/c/a/i2;-><init>(Lcom/android/camera/ThumbnailUpdater;)V
...
.method public static synthetic b(Lcom/android/camera/ThumbnailUpdater;Ld/c/a/j5;ZZZ)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/camera/ThumbnailUpdater;->v(Ld/c/a/j5;ZZZ)V
...
.method private static g(Z)Landroid/net/Uri;
    ...
    invoke-static {v3}, Ld/c/a/n6/a/b/a;->j(Landroid/content/Context;)Ljava/lang/String;
...
.method private synthetic q(ZIZ)V
    ...
    :cond_0
    invoke-interface {v0}, Ld/c/a/a7/h/h;->canProvide()Z
    ...
    :cond_1
    iget-object p0, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/c/a/j5;

    invoke-interface {v0, p0, p1, p2, p3}, Ld/c/a/a7/h/h;->P4(Ld/c/a/j5;ZIZ)V
...
.method private v(Ld/c/a/j5;ZZZ)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    iput-object p1, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/c/a/j5;

    if-eqz p2, :cond_0

    invoke-virtual {p0, p3, p4}, Lcom/android/camera/ThumbnailUpdater;->x(ZZ)V
...
.method public f()V
    ...
    new-instance v1, Ld/c/a/g2;

    invoke-direct {v1, p0}, Ld/c/a/g2;-><init>(Lcom/android/camera/ThumbnailUpdater;)V
...
.method public h()V
    ...
    invoke-virtual {v1}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->d()V
    ...
    iget-object v5, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/c/a/j5;

    invoke-direct {v1, v3, v4, p0, v5}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Ld/c/a/j5;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->h(Ljava/lang/String;[Ljava/lang/Object;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;
...
.method public i(Z)V
    ...
    iget-object v8, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/c/a/j5;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Ld/c/a/j5;)V
    ...
    invoke-virtual {p1, v0, v1}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->h(Ljava/lang/String;[Ljava/lang/Object;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;
...
.method public t()V
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/c/a/j5;

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Ld/c/a/j5;->m()Z
    ...
    new-array v3, v3, [Ld/c/a/j5;

    iget-object p0, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/c/a/j5;

    aput-object p0, v3, v1

    invoke-virtual {v0, v2, v3}, Lcom/xiaomi/camera/common/LifecycleAsyncTask;->h(Ljava/lang/String;[Ljava/lang/Object;)Lcom/xiaomi/camera/common/LifecycleAsyncTask;

    :cond_1
    return-void
.end method

.method public u(Ld/c/a/j5;ZZ)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/android/camera/ThumbnailUpdater;->v(Ld/c/a/j5;ZZZ)V
...
.method public x(ZZ)V
    ...
    new-instance v2, Ld/c/a/h2;

    invoke-direct {v2, p0, p1, v0, p2}, Ld/c/a/h2;-><init>(Lcom/android/camera/ThumbnailUpdater;ZIZ)V
