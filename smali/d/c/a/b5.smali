...
.field private static final b:Ld/m/f/q/c;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Ld/c/a/b5$a;

    invoke-direct {v0}, Ld/c/a/b5$a;-><init>()V

    sput-object v0, Ld/c/a/b5;->b:Ld/m/f/q/c;
...
.method public synthetic constructor <init>(Ld/c/a/b5$a;)V
    .locals 0

    invoke-direct {p0}, Ld/c/a/b5;-><init>()V
...
.method private a(Ljava/io/IOException;)V
    ...
    invoke-direct {p0}, Ld/c/a/b5;->b()Landroid/os/MemoryFile;
    ...
    invoke-direct {p0, p1}, Ld/c/a/b5;->j(Landroid/os/MemoryFile;)V

    iput v0, p0, Ld/c/a/b5;->d:I

    iput v0, p0, Ld/c/a/b5;->e:I

    iput v0, p0, Ld/c/a/b5;->f:I

    iput-object p1, p0, Ld/c/a/b5;->g:Landroid/net/Uri;
...
.method private declared-synchronized b()Landroid/os/MemoryFile;
    ...
    :try_start_0
    iget-object v0, p0, Ld/c/a/b5;->c:Landroid/os/MemoryFile;
    :try_end_0
...
.method public static e()Ld/c/a/b5;
    .locals 1

    sget-object v0, Ld/c/a/b5;->b:Ld/m/f/q/c;

    invoke-virtual {v0}, Ld/m/f/q/c;->b()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Ld/c/a/b5;
...
.method private declared-synchronized j(Landroid/os/MemoryFile;)V
    ...
    :try_start_0
    iput-object p1, p0, Ld/c/a/b5;->c:Landroid/os/MemoryFile;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized f()Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {v0}, Ld/m/i/c/e;->a(Landroid/os/MemoryFile;)Ljava/io/FileDescriptor;
...
.method public declared-synchronized g()Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v0, p0, Ld/c/a/b5;->g:Landroid/net/Uri;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized i(Landroid/net/Uri;Landroid/graphics/Bitmap;)Z
    ...
    invoke-direct {p0, v3}, Ld/c/a/b5;->j(Landroid/os/MemoryFile;)V

    invoke-virtual {p2}, Landroid/graphics/Bitmap;->getWidth()I

    move-result v2

    iput v2, p0, Ld/c/a/b5;->d:I

    invoke-virtual {p2}, Landroid/graphics/Bitmap;->getHeight()I

    move-result p2

    iput p2, p0, Ld/c/a/b5;->e:I

    iput v1, p0, Ld/c/a/b5;->f:I
    ...
    :try_start_2
    invoke-direct {p0, p1}, Ld/c/a/b5;->a(Ljava/io/IOException;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
