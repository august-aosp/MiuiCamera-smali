...
.method public static a(Ld/c/a/k7/p;Ld/c/a/k7/b0/c;ZZ)Landroid/net/Uri;
    .locals 10
    ...
    invoke-virtual {v3}, Ld/c/a/b6/e/x;->m()Z

    move-result v3

    if-eqz v3, :cond_0

    new-instance v3, Ld/c/a/l6/c$b;

    const-string v4, "com.xiaomi.duo_video_remote"

    invoke-direct {v3, v4, v2, v2}, Ld/c/a/l6/c$b;-><init>(Ljava/lang/String;[BLjava/lang/String;)V
    ...
    invoke-virtual/range {v3 .. v9}, Ld/c/a/k7/p;->y(Landroid/net/Uri;Ljava/lang/String;Landroid/content/ContentValues;ZZLjava/util/List;)Landroid/net/Uri;
    ...
    invoke-virtual {p0, p2, v2, p1, v1}, Ld/c/a/k7/p;->A(Landroid/net/Uri;Ljava/lang/String;Landroid/content/ContentValues;Z)Landroid/net/Uri;
