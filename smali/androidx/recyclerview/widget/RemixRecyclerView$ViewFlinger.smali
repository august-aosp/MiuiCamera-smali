...
.field private mHapticFeedbackCompat:Lh/i0/b;
...
.field public mOverScroller:Lh/u/b/c;
...
.method public constructor <init>(Landroidx/recyclerview/widget/RemixRecyclerView;)V
    ...
    new-instance v1, Lh/u/b/c;

    invoke-virtual {p1}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object p1

    invoke-direct {v1, p1, v0}, Lh/u/b/c;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;
...
.method private getHapticFeedbackCompat()Lh/i0/b;
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lh/i0/b;
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lh/i0/b;

    :cond_0
    iget-object p0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mHapticFeedbackCompat:Lh/i0/b;
...
.method public fling(II)V
    ...
    invoke-direct {v2, v4, v3}, Lh/u/b/c;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object v2, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;
    ...
    :cond_7
    :goto_0
    iget-object v2, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;
    ...
    invoke-virtual/range {v2 .. v10}, Lh/u/b/c;->d(IIIIIIII)V
...
.method public run()V
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;

    invoke-virtual {v1}, Lh/u/b/c;->b()Z

    move-result v4

    if-eqz v4, :cond_21

    invoke-virtual {v1}, Lh/u/b/c;->j()I

    move-result v4

    invoke-virtual {v1}, Lh/u/b/c;->k()I

    move-result v5

    iget-object v6, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;

    invoke-virtual {v6}, Lh/u/b/c;->o()I

    move-result v6

    if-ne v6, v3, :cond_1

    invoke-virtual {v1}, Lh/u/b/c;->h()F
    ...
    invoke-virtual {v1}, Lh/u/b/c;->i()F
    ...
    iget-object v4, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;

    invoke-virtual {v4}, Lh/u/b/c;->o()I
    ...
    instance-of v7, v4, Lh/e/e/a;

    if-eqz v7, :cond_2

    move-object v7, v4

    check-cast v7, Lh/e/e/a;

    iget-object v8, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;

    invoke-virtual {v8}, Lh/u/b/c;->h()F

    move-result v8

    iget-object v9, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;

    invoke-virtual {v9}, Lh/u/b/c;->i()F

    move-result v9

    invoke-interface {v7, v8, v9}, Lh/e/e/a;->a(FF)Z
    ...
    invoke-virtual {v1}, Lh/u/b/c;->m()I
    ...
    invoke-virtual {v1}, Lh/u/b/c;->n()I
    ...
    :goto_4
    invoke-virtual {v1}, Lh/u/b/c;->r()Z
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;

    invoke-virtual {v5}, Lh/u/b/c;->q()I
    ...
    invoke-virtual {v5}, Lh/u/b/c;->p()I
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->getHapticFeedbackCompat()Lh/i0/b;

    move-result-object v1

    const/16 v4, 0xc9

    invoke-virtual {v1, v4}, Lh/i0/b;->d(I)Z
...
.method public smoothScrollBy(IIILandroid/view/animation/Interpolator;)V
    ...
    :cond_2
    iget-object p3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;

    invoke-virtual {p3}, Lh/u/b/c;->o()I
    ...
    invoke-virtual {p3}, Lh/u/b/c;->i()F
    ...
    invoke-virtual {p3}, Lh/u/b/c;->h()F
    ...
    invoke-direct {p3, v2, p4}, Lh/u/b/c;-><init>(Landroid/content/Context;Landroid/view/animation/Interpolator;)V

    iput-object p3, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;
    ...
    invoke-virtual/range {v1 .. v7}, Lh/u/b/c;->G(IIIIII)V
    ...
    iget-object p1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;
...
.method public stop()V
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lh/u/b/c;
