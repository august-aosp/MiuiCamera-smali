...
.field private t:Ld/m/u/f/c/y;

.field private u:I

.field private v1:Ld/m/u/f/c/z;
...
.method private Bd()V
    ...
    invoke-direct {p0}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->Td()V
...
.method private Id(Ljava/util/HashMap;)V
    ...
    invoke-virtual {v3, v2}, Lcom/xiaomi/microfilm/vlog/vv/VVGalleryAdapter;->j(I)Ld/m/u/f/c/z;
    ...
    invoke-static {v0, v3}, Ld/c/a/k5;->c(Landroid/content/Context;I)V
    ...
    :cond_5
    :goto_2
    iget-object v0, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->v1:Ld/m/u/f/c/z;
    ...
    invoke-direct {p0, v0}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->Nb(Ld/m/u/f/c/z;)V
...
.method private Jb(Ld/m/u/f/c/z;)V
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    iget-object v0, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->K1:Ld/c/a/y5/f/o;
...
.method public static synthetic Lc(Ljava/lang/Throwable;)Ljava/util/List;
    .locals 0
...
.method private Nb(Ld/m/u/f/c/z;)V
    .locals 2
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method public static synthetic Nc(Ld/c/a/r6/f;)Lio/reactivex/ObservableSource;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-virtual {p0}, Ld/c/a/r6/f;->getDownloadUrl()Ljava/lang/String;
...
.method private Ob()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->m:Ld/m/u/f/c/a0;
    ...
    iput-object v0, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->K1:Ld/c/a/y5/f/o;

    new-instance v1, Ld/m/u/f/c/f;

    invoke-direct {v1, p0}, Ld/m/u/f/c/f;-><init>(Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;)V
    ...
    iget-object v1, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->m:Ld/m/u/f/c/a0;

    iget-object v1, v1, Lcom/android/camera/resource/BaseResourceList;->version:Ljava/lang/String;

    invoke-virtual {v0, v1}, Ld/c/a/y5/e/k/d;->w0(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->t:Ld/m/u/f/c/y;

    invoke-interface {v0}, Ld/m/u/f/c/y;->a()V
    ...
    iget-object v2, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->m:Ld/m/u/f/c/a0;
    ...
    iget-object v0, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->t:Ld/m/u/f/c/y;
    ...
    invoke-interface {v0, v2}, Ld/m/u/f/c/y;->b(Ld/m/u/f/c/z;)V
    ...
    iget-object v5, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->m:Ld/m/u/f/c/a0;
    ...
    iget-object v9, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->t:Ld/m/u/f/c/y;
    ...
    invoke-direct/range {v4 .. v10}, Lcom/xiaomi/microfilm/vlog/vv/VVGalleryAdapter;-><init>(Ld/m/u/f/c/a0;Landroidx/recyclerview/widget/LinearLayoutManager;ILandroid/view/View$OnClickListener;Ld/m/u/f/c/y;Lcom/android/camera/fragment/EffectItemPadding;)V
...
.method private synthetic Tb(Lcom/android/camera/data/observeable/RxData$c;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->Id(Ljava/util/HashMap;)V
...
.method private Td()V
    ...
    invoke-static {v4}, Ld/c/a/s6/a;->c(Landroid/content/Context;)Z
    ...
    :cond_0
    invoke-direct {p0}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->gd()V
    ...
    sget-object v2, Ld/m/u/f/c/d;->c:Ld/m/u/f/c/d;

    invoke-virtual {v1, v2}, Lio/reactivex/Observable;->onErrorReturn(Lio/reactivex/functions/Function;)Lio/reactivex/Observable;

    move-result-object v1

    new-instance v2, Ld/c/a/r6/g;

    const-string v4, "14689487697936512"

    invoke-direct {v2, v4}, Ld/c/a/r6/g;-><init>(Ljava/lang/String;)V

    const-class v4, Ld/c/a/r6/f;
    ...
    :cond_5
    new-instance v1, Ld/m/u/f/c/k;

    invoke-direct {v1, p0, v3}, Ld/m/u/f/c/k;-><init>(Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;Z)V

    new-instance v2, Ld/m/u/f/c/g;

    invoke-direct {v2, p0, v3}, Ld/m/u/f/c/g;-><init>(Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;Z)V
...
.method public static synthetic Xc(Ljava/lang/Throwable;)Lcom/android/camera/resource/BaseResourceRaw;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private synthetic ac(Ld/m/u/f/c/a0;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    iput-object p1, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->m:Ld/m/u/f/c/a0;

    invoke-direct {p0}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->Ob()V

    return-void
.end method

.method private synthetic ad(ZLd/m/u/f/c/a0;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private gd()V
    ...
    invoke-virtual {v0}, Ld/c/a/y5/f/r;->f()Lio/reactivex/Observable;
    ...
    new-instance v1, Ld/m/u/f/c/h;

    invoke-direct {v1, p0}, Ld/m/u/f/c/h;-><init>(Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;)V

    sget-object v2, Ld/m/u/f/c/j;->c:Ld/m/u/f/c/j;
...
.method private he(ILandroid/view/View;)V
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {v0, p1, v1}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVPreview;->Nc(ILd/m/u/f/c/a0;)V

    iget-object p1, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->t:Ld/m/u/f/c/y;

    invoke-virtual {v0, p1}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVPreview;->Xc(Ld/m/u/f/c/y;)V
...
.method public static synthetic ob(Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;Ld/m/u/f/c/z;)Ld/m/u/f/c/z;
    .locals 0

    iput-object p1, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->v1:Ld/m/u/f/c/z;

    return-object p1
.end method

.method private synthetic pd(ZLjava/lang/Throwable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public static synthetic sb(Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;Ld/m/u/f/c/z;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->Nb(Ld/m/u/f/c/z;)V
...
.method public static synthetic wc(Ljava/lang/Throwable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private xd()V
    ...
    iput-object v0, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->m:Ld/m/u/f/c/a0;
    ...
    invoke-direct {p0}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->Bd()V
...
.method public synthetic Yb(Lcom/android/camera/data/observeable/RxData$c;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->Tb(Lcom/android/camera/data/observeable/RxData$c;)V
...
.method public initView(Landroid/view/View;)V
    ...
    invoke-direct {p0}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->xd()V
...
.method public synthetic kd(ZLd/m/u/f/c/a0;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->ad(ZLd/m/u/f/c/a0;)V
...
.method public m()Z
    ...
    :cond_1
    iget-object v2, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->v1:Ld/m/u/f/c/z;

    invoke-virtual {v2}, Ld/m/u/f/c/z;->i()Z
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->J()Z

    move-result v2

    iget-object v3, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->v1:Ld/m/u/f/c/z;

    iget-object v3, v3, Ld/m/u/f/c/z;->g:Ljava/lang/String;

    invoke-static {v3, v2}, Ld/c/a/j7/g;->E3(Ljava/lang/String;Z)V

    iget-object p0, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->v1:Ld/m/u/f/c/z;

    const/4 v2, 0x0

    const/4 v3, 0x1

    invoke-interface {v0, p0, v2, v3, v1}, Ld/c/a/a7/h/c0;->V1(Ld/m/u/f/c/z;Ld/m/u/f/c/d0;ZZ)V
...
.method public notifyAfterFrameAvailable(I)V
    ...
    iget-object p1, p0, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->v1:Ld/m/u/f/c/z;
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->he(ILandroid/view/View;)V

    return-void

    :cond_1
    invoke-direct {p0, v1}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->Jb(Ld/m/u/f/c/z;)V
...
.method public synthetic rc(Ld/m/u/f/c/a0;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->ac(Ld/m/u/f/c/a0;)V
...
.method public register(Ld/c/a/a7/c;)V
    ...
    const-class v0, Ld/c/a/a7/h/t3/e;
...
.method public synthetic ud(ZLjava/lang/Throwable;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/xiaomi/microfilm/vlog/vv/FragmentVVGallery;->pd(ZLjava/lang/Throwable;)V
