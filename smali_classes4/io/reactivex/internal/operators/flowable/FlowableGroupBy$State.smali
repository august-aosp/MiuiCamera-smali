...
.method public drainNormal()V
    ...
    :goto_2
    invoke-virtual {p0, v12, v14, v2, v1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLk/e/c;Z)Z
    ...
    :cond_3
    invoke-interface {v2, v13}, Lk/e/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v11, v12, v2, v1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLk/e/c;Z)Z
    ...
    iget-object v5, v5, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->s:Lk/e/d;

    invoke-interface {v5, v9, v10}, Lk/e/d;->request(J)V
