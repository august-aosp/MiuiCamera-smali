...
# virtual methods
.method public checkTerminated(ZZZLk/e/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p0}, Lk/e/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p4, p1}, Lk/e/c;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_2
    invoke-interface {p4}, Lk/e/c;->onComplete()V
...
.method public drain()V
    ...
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Lk/e/c;)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Lk/e/c;)V
...
.method public drainFused(Lk/e/c;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_2
    invoke-interface {p1, v4}, Lk/e/c;->onNext(Ljava/lang/Object;)V
...
.method public drainRegular(Lk/e/c;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLk/e/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    invoke-interface {v5, v8}, Lk/e/c;->onNext(Ljava/lang/Object;)V
