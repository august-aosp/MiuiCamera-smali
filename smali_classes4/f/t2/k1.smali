...
.method public static final a(Ljava/util/Set;)Ljava/util/Set;
    ...
    check-cast p0, Lf/t2/u1/j;

    invoke-virtual {p0}, Lf/t2/u1/j;->b()Ljava/util/Set;
...
.method private static final b(ILf/e3/x/l;)Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    invoke-static {p0}, Lf/t2/k1;->e(I)Ljava/util/Set;

    move-result-object p0

    invoke-interface {p1, p0}, Lf/e3/x/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p0}, Lf/t2/k1;->a(Ljava/util/Set;)Ljava/util/Set;
...
.method private static final c(Lf/e3/x/l;)Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    invoke-static {}, Lf/t2/k1;->d()Ljava/util/Set;

    move-result-object v0

    invoke-interface {p0, v0}, Lf/e3/x/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {v0}, Lf/t2/k1;->a(Ljava/util/Set;)Ljava/util/Set;
...
.method public static final d()Ljava/util/Set;
    ...
    new-instance v0, Lf/t2/u1/j;

    invoke-direct {v0}, Lf/t2/u1/j;-><init>()V
...
.method public static final e(I)Ljava/util/Set;
    ...
    invoke-direct {v0, p0}, Lf/t2/u1/j;-><init>(I)V
...
.method public static final varargs g(Ljava/util/Comparator;[Ljava/lang/Object;)Ljava/util/TreeSet;
    ...
    invoke-static {p1, v0}, Lf/t2/p;->Ny([Ljava/lang/Object;Ljava/util/Collection;)Ljava/util/Collection;
...
.method public static final varargs h([Ljava/lang/Object;)Ljava/util/TreeSet;
    ...
    invoke-static {p0, v0}, Lf/t2/p;->Ny([Ljava/lang/Object;Ljava/util/Collection;)Ljava/util/Collection;
