...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lf/t2/v;-><init>()V

    return-void
.end method

.method public static synthetic A(Ljava/util/List;Ljava/lang/Comparable;IILf/e3/x/l;ILjava/lang/Object;)I
    .locals 0
    ...
    :cond_1
    new-instance p5, Lf/t2/w$a;

    invoke-direct {p5, p4, p1}, Lf/t2/w$a;-><init>(Lf/e3/x/l;Ljava/lang/Comparable;)V

    invoke-static {p0, p2, p3, p5}, Lf/t2/w;->t(Ljava/util/List;IILf/e3/x/l;)I
...
.method private static final B(ILf/e3/x/l;)Ljava/util/List;
    .locals 1
    .param p1    # Lf/e3/x/l;
    ...
    invoke-static {p0}, Lf/t2/v;->j(I)Ljava/util/List;

    move-result-object p0

    invoke-interface {p1, p0}, Lf/e3/x/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p0}, Lf/t2/v;->a(Ljava/util/List;)Ljava/util/List;
...
.method private static final C(Lf/e3/x/l;)Ljava/util/List;
    .locals 1
    .param p0    # Lf/e3/x/l;
        .annotation build Lf/b;
        .end annotation
    ...
    invoke-static {}, Lf/t2/v;->i()Ljava/util/List;

    move-result-object v0

    invoke-interface {p0, v0}, Lf/e3/x/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {v0}, Lf/t2/v;->a(Ljava/util/List;)Ljava/util/List;
...
.method public static final E()Ljava/util/List;
    ...
    sget-object v0, Lf/t2/h0;->c:Lf/t2/h0;

    return-object v0
.end method

.method public static final F(Ljava/util/Collection;)Lf/i3/l;
    .locals 2
...
.method private static final H(Ljava/util/Collection;Lf/e3/x/a;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<C::",
...
.method public static final varargs N([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {p0}, Lf/t2/p;->ub([Ljava/lang/Object;)Ljava/util/List;
...
.method public static final varargs P([Ljava/lang/Object;)Ljava/util/List;
    ...
    new-instance v1, Lf/t2/j;

    const/4 v2, 0x1

    invoke-direct {v1, p0, v2}, Lf/t2/j;-><init>([Ljava/lang/Object;Z)V
...
.method public static final U(Ljava/lang/Iterable;Lf/h3/f;)Ljava/util/List;
    .locals 1
    ...
    invoke-static {p0}, Lf/t2/e0;->S5(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object p0

    invoke-static {p0, p1}, Lf/t2/e0;->Z4(Ljava/util/List;Lf/h3/f;)V
...
.method private static final o(ILf/e3/x/l;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final p(ILf/e3/x/l;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static final s([Ljava/lang/Object;)Ljava/util/Collection;
    ...
    new-instance v0, Lf/t2/j;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lf/t2/j;-><init>([Ljava/lang/Object;Z)V

    return-object v0
.end method

.method public static final t(Ljava/util/List;IILf/e3/x/l;)I
    .locals 2
    .param p0    # Ljava/util/List;
        .annotation build Lk/d/a/d;
        .end annotation
    ...
    invoke-static {v0, p1, p2}, Lf/t2/w;->T(III)V
    ...
    invoke-interface {p3, v1}, Lf/e3/x/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final u(Ljava/util/List;Ljava/lang/Comparable;II)I
    ...
    invoke-static {v0, p2, p3}, Lf/t2/w;->T(III)V
    ...
    invoke-static {v1, p1}, Lf/u2/g;->g(Ljava/lang/Comparable;Ljava/lang/Comparable;)I
...
.method public static final v(Ljava/util/List;Ljava/lang/Object;Ljava/util/Comparator;II)I
    ...
    invoke-static {v0, p3, p4}, Lf/t2/w;->T(III)V
...
.method public static synthetic w(Ljava/util/List;IILf/e3/x/l;ILjava/lang/Object;)I
    .locals 0
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3}, Lf/t2/w;->t(Ljava/util/List;IILf/e3/x/l;)I
...
.method public static synthetic x(Ljava/util/List;Ljava/lang/Comparable;IIILjava/lang/Object;)I
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3}, Lf/t2/w;->u(Ljava/util/List;Ljava/lang/Comparable;II)I
...
.method public static synthetic y(Ljava/util/List;Ljava/lang/Object;Ljava/util/Comparator;IIILjava/lang/Object;)I
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3, p4}, Lf/t2/w;->v(Ljava/util/List;Ljava/lang/Object;Ljava/util/Comparator;II)I
...
.method public static final z(Ljava/util/List;Ljava/lang/Comparable;IILf/e3/x/l;)I
    .locals 1
    .param p0    # Ljava/util/List;
        .annotation build Lk/d/a/d;
        .end annotation
    ...
    new-instance v0, Lf/t2/w$a;

    invoke-direct {v0, p4, p1}, Lf/t2/w$a;-><init>(Lf/e3/x/l;Ljava/lang/Comparable;)V

    invoke-static {p0, p2, p3, v0}, Lf/t2/w;->t(Ljava/util/List;IILf/e3/x/l;)I
