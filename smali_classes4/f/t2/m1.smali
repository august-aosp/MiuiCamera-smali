...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Lf/t2/l1;-><init>()V
...
.method private static final B(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/Set;
    ...
    invoke-static {p0, p1}, Lf/t2/m1;->y(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/Set;
...
.method public static final C(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-static {p1}, Lf/t2/x;->Z(Ljava/lang/Iterable;)Ljava/lang/Integer;
    ...
    invoke-static {v1, p1}, Lf/t2/b0;->n0(Ljava/util/Collection;Ljava/lang/Iterable;)Z
...
.method public static final E(Ljava/util/Set;Lf/k3/m;)Ljava/util/Set;
    .locals 2
    .param p0    # Ljava/util/Set;
        .annotation build Lk/d/a/d;
        .end annotation
    ...
    invoke-static {v0, p1}, Lf/t2/b0;->o0(Ljava/util/Collection;Lf/k3/m;)Z
...
.method public static final F(Ljava/util/Set;[Ljava/lang/Object;)Ljava/util/Set;
    ...
    invoke-static {v0, p1}, Lf/t2/b0;->p0(Ljava/util/Collection;[Ljava/lang/Object;)Z

    return-object v0
.end method

.method private static final G(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, p1}, Lf/t2/m1;->D(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/Set;
...
.method public static final x(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-static {p0}, Lf/t2/e0;->V5(Ljava/lang/Iterable;)Ljava/util/Set;
...
.method public static final z(Ljava/util/Set;Lf/k3/m;)Ljava/util/Set;
    .locals 1
    .param p0    # Ljava/util/Set;
        .annotation build Lk/d/a/d;
        .end annotation
