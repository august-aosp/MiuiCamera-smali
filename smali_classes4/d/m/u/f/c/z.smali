...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Ld/m/u/f/c/z$a;

    invoke-direct {v0}, Ld/m/u/f/c/z$a;-><init>()V

    sput-object v0, Ld/m/u/f/c/z;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Ld/m/u/f/c/z;->K1:Z
...
.method public constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Ld/m/u/f/c/z;->g:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Ld/m/u/f/c/z;->m:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Ld/m/u/f/c/z;->n:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Ld/m/u/f/c/z;->p:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Ld/m/u/f/c/z;->s:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Ld/m/u/f/c/z;->t:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Ld/m/u/f/c/z;->u:Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Ld/m/u/f/c/z;->k1:Ljava/util/List;
    ...
    iput-wide v0, p0, Ld/m/u/f/c/z;->C1:J
...
.method public static final a(Ljava/lang/String;)Ld/m/u/f/c/z;
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    :cond_0
    new-instance v0, Ld/m/u/f/c/z;

    invoke-direct {v0}, Ld/m/u/f/c/z;-><init>()V
    ...
    invoke-virtual {v0, v2, p0}, Ld/m/u/f/c/z;->parseSummaryData(Lorg/json/JSONObject;I)V
    :try_end_0
    ...
    invoke-virtual {v0, v2}, Ld/m/u/f/c/z;->simpleVerification(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-virtual {v0, v2, p0}, Ld/m/u/f/c/z;->onDecompressFinished(Ljava/lang/String;Z)V
...
.method public b(I)J
    ...
    iget-object p0, p0, Ld/m/u/f/c/z;->k1:Ljava/util/List;
...
.method public e()J
    ...
    iget-wide v0, p0, Ld/m/u/f/c/z;->C1:J
...
.method public i()Z
    ...
    iget-object p0, p0, Ld/m/u/f/c/z;->w:Ljava/lang/String;
...
.method public onDecompressFailed(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Ld/m/u/f/c/z;->i()Z
...
.method public parseSummaryData(Lorg/json/JSONObject;I)V
    ...
    iput-object v0, p0, Ld/m/u/f/c/z;->v2:Ljava/lang/String;

    iput p2, p0, Ld/m/u/f/c/z;->j:I
    ...
    iput-boolean v1, p0, Ld/m/u/f/c/z;->K1:Z
    ...
    iput-object p2, p0, Ld/m/u/f/c/z;->w:Ljava/lang/String;
    ...
    iput-object p2, p0, Ld/m/u/f/c/z;->k0:Ljava/lang/String;
    ...
    iput-wide v2, p0, Ld/m/u/f/c/z;->K0:J
    ...
    iput-object v2, p0, Ld/m/u/f/c/z;->k1:Ljava/util/List;
    ...
    iget-object v5, p0, Ld/m/u/f/c/z;->v1:Ljava/util/List;
    ...
    iput-object v5, p0, Ld/m/u/f/c/z;->v1:Ljava/util/List;
    ...
    iget-object v5, p0, Ld/m/u/f/c/z;->k1:Ljava/util/List;
    ...
    iget-wide v3, p0, Ld/m/u/f/c/z;->C1:J
    ...
    iput-wide v3, p0, Ld/m/u/f/c/z;->C1:J
    ...
    :cond_4
    iget-wide v2, p0, Ld/m/u/f/c/z;->C1:J

    const-wide/16 v4, 0x7d0

    add-long/2addr v2, v4

    iput-wide v2, p0, Ld/m/u/f/c/z;->C1:J
    ...
    iput-object p1, p0, Ld/m/u/f/c/z;->g:Ljava/lang/String;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object p2, p0, Ld/m/u/f/c/z;->g:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object p2, p0, Ld/m/u/f/c/z;->m:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object p2, p0, Ld/m/u/f/c/z;->n:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object p2, p0, Ld/m/u/f/c/z;->p:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object p2, p0, Ld/m/u/f/c/z;->s:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object p2, p0, Ld/m/u/f/c/z;->t:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object p2, p0, Ld/m/u/f/c/z;->u:Ljava/lang/String;

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    iget-object p2, p0, Ld/m/u/f/c/z;->k1:Ljava/util/List;
