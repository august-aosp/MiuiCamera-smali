...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ld/m/p/i;->D:[F

    const/4 v0, 0x1

    iput-boolean v0, p0, Ld/m/p/i;->E:Z

    const/4 v0, 0x0

    iput v0, p0, Ld/m/p/i;->N:I

    iput v0, p0, Ld/m/p/i;->O:I

    iput v0, p0, Ld/m/p/i;->P:I

    iput v0, p0, Ld/m/p/i;->Q:I
...
.method private static w()V
    ...
    invoke-static {v1, v0}, Ld/m/p/i;->u(ZLjava/lang/String;)V
...
.method public j(II)V
    ...
    iget-boolean v0, p0, Ld/m/p/i;->E:Z

    invoke-static {p1, p2, v0}, Ld/m/p/g;->i(IIZ)I

    move-result p1

    iput p1, p0, Ld/m/p/i;->C:I

    iget p1, p0, Ld/m/p/b;->c:I
...
.method public l(IIIIII)V
    ...
    iput p3, p0, Ld/m/p/i;->N:I

    iput p4, p0, Ld/m/p/i;->O:I

    iput p5, p0, Ld/m/p/i;->P:I

    iput p6, p0, Ld/m/p/i;->Q:I

    iput p1, p0, Ld/m/p/i;->M:I

    iput p2, p0, Ld/m/p/i;->L:I
...
.method public m()V
    ...
    iget v0, p0, Ld/m/p/i;->B:I

    if-eqz v0, :cond_1

    iget v0, p0, Ld/m/p/i;->C:I
    ...
    :cond_0
    iget-object v0, p0, Ld/m/p/i;->D:[F

    const/4 v1, 0x0

    invoke-static {v0, v1}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    iget-object v2, p0, Ld/m/p/i;->D:[F
    ...
    iget v0, p0, Ld/m/p/i;->A:I

    const/4 v2, 0x1

    iget-object v3, p0, Ld/m/p/i;->D:[F

    invoke-static {v0, v2, v1, v3, v1}, Landroid/opengl/GLES30;->glUniformMatrix4fv(IIZ[FI)V

    iget v0, p0, Ld/m/p/i;->H:I

    iget v2, p0, Ld/m/p/i;->N:I

    invoke-static {v0, v2}, Landroid/opengl/GLES30;->glUniform1i(II)V

    invoke-static {}, Ld/m/p/i;->w()V

    iget v0, p0, Ld/m/p/i;->I:I

    iget v2, p0, Ld/m/p/i;->O:I

    invoke-static {v0, v2}, Landroid/opengl/GLES30;->glUniform1i(II)V

    invoke-static {}, Ld/m/p/i;->w()V

    iget v0, p0, Ld/m/p/i;->J:I

    iget v2, p0, Ld/m/p/i;->P:I

    invoke-static {v0, v2}, Landroid/opengl/GLES30;->glUniform1i(II)V

    invoke-static {}, Ld/m/p/i;->w()V

    iget v0, p0, Ld/m/p/i;->K:I

    iget v2, p0, Ld/m/p/i;->Q:I

    invoke-static {v0, v2}, Landroid/opengl/GLES30;->glUniform1i(II)V

    invoke-static {}, Ld/m/p/i;->w()V

    iget v0, p0, Ld/m/p/i;->F:I

    iget v2, p0, Ld/m/p/i;->M:I

    invoke-static {v0, v2}, Landroid/opengl/GLES30;->glUniform1i(II)V

    invoke-static {}, Ld/m/p/i;->w()V

    iget v0, p0, Ld/m/p/i;->G:I

    iget v2, p0, Ld/m/p/i;->L:I

    invoke-static {v0, v2}, Landroid/opengl/GLES30;->glUniform1i(II)V

    invoke-static {}, Ld/m/p/i;->w()V

    iget v0, p0, Ld/m/p/i;->x:I

    invoke-static {v0}, Landroid/opengl/GLES30;->glEnableVertexAttribArray(I)V

    invoke-static {}, Ld/m/p/i;->w()V

    iget v0, p0, Ld/m/p/i;->y:I
    ...
    iget v0, p0, Ld/m/p/b;->m:I

    invoke-static {v2, v0}, Landroid/opengl/GLES30;->glBindBuffer(II)V

    invoke-static {}, Ld/m/p/i;->w()V

    iget v3, p0, Ld/m/p/i;->y:I
    ...
    invoke-direct {p0, v0}, Ld/m/p/i;->v(I)V

    invoke-static {}, Ld/m/p/i;->w()V

    const/4 v0, 0x5

    iget v2, p0, Ld/m/p/b;->t:I
...
.method public q(Z)V
    ...
    iput-boolean p1, p0, Ld/m/p/i;->E:Z
