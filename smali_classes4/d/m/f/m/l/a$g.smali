...
.field public final synthetic m:Ld/m/f/m/l/a;


# direct methods
.method public constructor <init>(Ld/m/f/m/l/a;Ljava/net/Socket;)V
    .locals 3
    ...
    iput-object p1, p0, Ld/m/f/m/l/a$g;->m:Ld/m/f/m/l/a;
    ...
    iput-object v0, p0, Ld/m/f/m/l/a$g;->c:Ljava/lang/String;

    iput-object p2, p0, Ld/m/f/m/l/a$g;->d:Ljava/net/Socket;
    ...
    iput-object v0, p0, Ld/m/f/m/l/a$g;->g:Ljava/io/BufferedReader;

    invoke-virtual {p2}, Ljava/net/Socket;->getOutputStream()Ljava/io/OutputStream;

    move-result-object p2

    iput-object p2, p0, Ld/m/f/m/l/a$g;->f:Ljava/io/OutputStream;

    new-instance p2, Lnet/majorkernelpanic/streaming/Session;

    invoke-direct {p2}, Lnet/majorkernelpanic/streaming/Session;-><init>()V

    iput-object p2, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-static {p0, p1}, Ld/m/f/m/m/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic a(Ld/m/f/m/l/a$g;)Lnet/majorkernelpanic/streaming/Session;
    .locals 0

    iget-object p0, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;

    return-object p0
.end method

.method public static synthetic c(Ld/m/f/m/l/a$g;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {p0}, Ld/m/f/m/l/a$g;->f()V

    return-void
.end method

.method private d(Ld/m/f/m/l/a$b;)Z
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    iget-object p1, p1, Ld/m/f/m/l/a$b;->e:Ljava/util/HashMap;
    ...
    iget-object v0, p0, Ld/m/f/m/l/a$g;->m:Ld/m/f/m/l/a;

    invoke-static {v0}, Ld/m/f/m/l/a;->h(Ld/m/f/m/l/a;)Ljava/lang/String;
    ...
    invoke-static {v0}, Ld/m/f/m/l/a;->i(Ld/m/f/m/l/a;)Ljava/lang/String;
    ...
    iget-object v2, p0, Ld/m/f/m/l/a$g;->m:Ld/m/f/m/l/a;

    invoke-static {v2}, Ld/m/f/m/l/a;->h(Ld/m/f/m/l/a;)Ljava/lang/String;
    ...
    iget-object p0, p0, Ld/m/f/m/l/a$g;->m:Ld/m/f/m/l/a;

    invoke-static {p0}, Ld/m/f/m/l/a;->i(Ld/m/f/m/l/a;)Ljava/lang/String;
...
.method private declared-synchronized f()V
    ...
    iget-object v1, p0, Ld/m/f/m/l/a$g;->f:Ljava/io/OutputStream;
...
# virtual methods
.method public e(Ld/m/f/m/l/a$b;)Ld/m/f/m/l/a$d;
    .locals 14
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    new-instance v0, Ld/m/f/m/l/a$d;

    invoke-direct {v0, p1}, Ld/m/f/m/l/a$d;-><init>(Ld/m/f/m/l/a$b;)V

    iget-object v1, p0, Ld/m/f/m/l/a$g;->m:Ld/m/f/m/l/a;

    invoke-static {v1}, Ld/m/f/m/l/a;->b(Ld/m/f/m/l/a;)Ljava/util/Map;
    ...
    :try_start_0
    iget-object v2, p0, Ld/m/f/m/l/a$g;->c:Ljava/lang/String;
    ...
    invoke-static {v2}, Ld/m/f/m/l/a;->b(Ld/m/f/m/l/a;)Ljava/util/Map;
    ...
    iget-object v6, p0, Ld/m/f/m/l/a$g;->c:Ljava/lang/String;
    ...
    invoke-static {v5}, Ld/m/f/m/m/a;->h(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v6, v7}, Ld/m/f/m/m/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v6, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    iput-object p1, v0, Ld/m/f/m/l/a$d;->h:Ljava/lang/String;
    ...
    iput-object p0, v0, Ld/m/f/m/l/a$d;->g:Ljava/lang/String;

    const-string p0, "400 Bad Request"

    iput-object p0, v0, Ld/m/f/m/l/a$d;->f:Ljava/lang/String;

    return-object v0

    :cond_2
    invoke-direct {p0, p1}, Ld/m/f/m/l/a$g;->d(Ld/m/f/m/l/a$b;)Z

    move-result v1

    if-nez v1, :cond_3

    iget-object v1, p1, Ld/m/f/m/l/a$b;->c:Ljava/lang/String;
    ...
    iput-object p0, v0, Ld/m/f/m/l/a$d;->h:Ljava/lang/String;
    ...
    iget-object p1, p1, Ld/m/f/m/l/a$b;->d:Ljava/lang/String;

    iget-object v2, p0, Ld/m/f/m/l/a$g;->d:Ljava/net/Socket;

    invoke-virtual {v1, p1, v2}, Ld/m/f/m/l/a;->p(Ljava/lang/String;Ljava/net/Socket;)Lnet/majorkernelpanic/streaming/Session;

    move-result-object p1

    iput-object p1, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;

    iget-object p1, p0, Ld/m/f/m/l/a$g;->c:Ljava/lang/String;
    ...
    iget-object v2, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object p1, p0, Ld/m/f/m/l/a$g;->m:Ld/m/f/m/l/a;

    invoke-static {p1}, Ld/m/f/m/l/a;->b(Ld/m/f/m/l/a;)Ljava/util/Map;
    ...
    iget-object v3, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object p1, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object p0, p0, Ld/m/f/m/l/a$g;->d:Ljava/net/Socket;
    ...
    iput-object p1, v0, Ld/m/f/m/l/a$d;->g:Ljava/lang/String;
    ...
    iget-object v5, p1, Ld/m/f/m/l/a$b;->d:Ljava/lang/String;
    ...
    iget-object v5, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v7, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v8, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;

    invoke-virtual {v8}, Lnet/majorkernelpanic/streaming/Session;->getDestination()Ljava/lang/String;

    move-result-object v8

    iget-object v9, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v10, p0, Ld/m/f/m/l/a$g;->c:Ljava/lang/String;
    ...
    invoke-static {v10, v11}, Ld/m/f/m/m/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v10, p0, Ld/m/f/m/l/a$g;->m:Ld/m/f/m/l/a;
    ...
    :try_start_4
    invoke-static {}, Ld/m/f/m/l/a;->e()Z

    move-result v11

    if-eqz v11, :cond_c

    iget-object v11, p0, Ld/m/f/m/l/a$g;->m:Ld/m/f/m/l/a;

    iget-object v12, v11, Ld/m/f/m/l/a;->y:Landroid/media/MediaCodec;

    if-nez v12, :cond_a

    iget-object v11, p0, Ld/m/f/m/l/a$g;->c:Ljava/lang/String;

    const-string v12, "create shared video codec"

    invoke-static {v11, v12}, Ld/m/f/m/m/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v11, p0, Ld/m/f/m/l/a$g;->m:Ld/m/f/m/l/a;

    iget-object v12, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v13, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-virtual {v11, v12, v13}, Ld/m/f/m/l/a;->k(Landroid/content/SharedPreferences;Lnet/majorkernelpanic/streaming/video/VideoQuality;)V

    goto :goto_2

    :cond_a
    iget-object v11, v11, Ld/m/f/m/l/a;->x:Lnet/majorkernelpanic/streaming/video/VideoQuality;
    ...
    invoke-static {}, Ld/m/f/m/l/a;->f()Z
    ...
    iget-object v10, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;

    invoke-virtual {v10, v1}, Lnet/majorkernelpanic/streaming/Session;->syncStart(I)V

    iget-object v1, p0, Ld/m/f/m/l/a$g;->c:Ljava/lang/String;
    ...
    iget-object v11, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-static {v1, v10}, Ld/m/f/m/m/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    if-nez v9, :cond_e

    iget-object v1, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-static {v1, v9}, Ld/m/f/m/m/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Ld/m/f/m/l/a$g;->m:Ld/m/f/m/l/a;

    iget-object v9, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;

    invoke-virtual {v1, v9, v4}, Ld/m/f/m/l/a;->s(Lnet/majorkernelpanic/streaming/Session;I)V
    ...
    iget-object p1, p0, Ld/m/f/m/l/a$g;->d:Ljava/net/Socket;
    ...
    invoke-static {p0}, Ld/m/f/m/m/a;->h(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v3}, Ld/m/f/m/m/a;->h(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v1}, Ld/m/f/m/l/a;->g(Ld/m/f/m/l/a;)Ld/m/f/m/l/a$e;
    ...
    invoke-static {p0}, Ld/m/f/m/l/a;->g(Ld/m/f/m/l/a;)Ld/m/f/m/l/a$e;

    move-result-object p0

    iget-object p1, p1, Ld/m/f/m/l/a$b;->f:Ljava/lang/String;

    invoke-interface {p0, p1}, Ld/m/f/m/l/a$e;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_19
    iget-object p0, p0, Ld/m/f/m/l/a$g;->c:Ljava/lang/String;
...
.method public run()V
    ...
    :try_start_0
    iget-object v4, p0, Ld/m/f/m/l/a$g;->g:Ljava/io/BufferedReader;

    invoke-static {v4}, Ld/m/f/m/l/a$b;->a(Ljava/io/BufferedReader;)Ld/m/f/m/l/a$b;
    ...
    new-instance v2, Ld/m/f/m/l/a$d;

    invoke-direct {v2}, Ld/m/f/m/l/a$d;-><init>()V

    const-string v4, "400 Bad Request"

    iput-object v4, v2, Ld/m/f/m/l/a$d;->f:Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {p0, v3}, Ld/m/f/m/l/a$g;->e(Ld/m/f/m/l/a$b;)Ld/m/f/m/l/a$d;
    ...
    iget-object v5, p0, Ld/m/f/m/l/a$g;->c:Ljava/lang/String;
    ...
    :goto_2
    invoke-static {v5, v2}, Ld/m/f/m/m/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, p0, Ld/m/f/m/l/a$g;->m:Ld/m/f/m/l/a;

    invoke-virtual {v2, v4}, Ld/m/f/m/l/a;->r(I)V

    new-instance v2, Ld/m/f/m/l/a$d;

    invoke-direct {v2, v3}, Ld/m/f/m/l/a$d;-><init>(Ld/m/f/m/l/a$b;)V
    ...
    iget-object v3, p0, Ld/m/f/m/l/a$g;->c:Ljava/lang/String;
    ...
    :try_start_3
    iget-object v3, p0, Ld/m/f/m/l/a$g;->f:Ljava/io/OutputStream;

    invoke-virtual {v2, v3}, Ld/m/f/m/l/a$d;->a(Ljava/io/OutputStream;)V
    ...
    :catch_2
    iget-object v0, p0, Ld/m/f/m/l/a$g;->c:Ljava/lang/String;

    const-string v1, "Response was not sent properly"

    invoke-static {v0, v1}, Ld/m/f/m/m/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_5
    :goto_4
    iget-object v0, p0, Ld/m/f/m/l/a$g;->j:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-virtual {v0, v1, v2}, Ld/m/f/m/l/a;->s(Lnet/majorkernelpanic/streaming/Session;I)V

    :cond_6
    iget-object v0, p0, Ld/m/f/m/l/a$g;->m:Ld/m/f/m/l/a;

    invoke-static {v0}, Ld/m/f/m/l/a;->b(Ld/m/f/m/l/a;)Ljava/util/Map;
    ...
    :try_start_6
    iget-object v0, p0, Ld/m/f/m/l/a$g;->d:Ljava/net/Socket;
