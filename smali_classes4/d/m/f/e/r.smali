...
.method public constructor <init>(Ld/m/f/e/v$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, Ld/m/f/e/n;-><init>(Ld/m/f/e/v$a;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    :goto_1
    iput-boolean p1, p0, Ld/m/f/e/r;->W:Z
...
.method private f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget-boolean p2, p0, Ld/m/f/e/r;->W:Z
    ...
    sget-object v0, Ld/c/b/x5/pp;->W1:Ld/c/b/x5/qp;

    invoke-virtual {v0}, Ld/c/b/x5/qp;->b()Ljava/lang/Object;
    ...
    :cond_2
    new-instance p1, Ld/m/f/e/r$d;

    invoke-direct {p1, p0}, Ld/m/f/e/r$d;-><init>(Ld/m/f/e/r;)V
    ...
    iget-object p1, p0, Ld/m/f/e/n;->T:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object p2, p0, Ld/m/f/e/n;->N:Lcom/xiaomi/engine/TaskSession;

    goto :goto_2

    :cond_3
    iget-object p2, p0, Ld/m/f/e/n;->O:Ld/m/f/e/j0;

    invoke-virtual {p2}, Ld/m/f/e/j0;->b()Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_4
    new-instance p1, Ld/m/f/e/r$e;

    invoke-direct {p1, p0}, Ld/m/f/e/r$e;-><init>(Ld/m/f/e/r;)V
...
.method private g0(Ld/m/f/e/h0;)V
    .locals 9
    ...
    invoke-virtual {v1}, Ld/m/f/e/p$a;->k()Landroid/media/Image;

    move-result-object v3

    invoke-virtual {p0, v2}, Ld/m/f/e/v;->q(Landroid/media/Image;)Z

    move-result v4

    invoke-virtual {p0, v3}, Ld/m/f/e/v;->q(Landroid/media/Image;)Z
    ...
    invoke-static {v8, v7}, Ld/m/f/a/e;->b(Ljava/lang/String;I)V

    invoke-virtual {v1}, Ld/m/f/e/p$a;->g()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p1}, Ld/m/f/e/h0;->e()I

    move-result v4

    invoke-direct {p0, v1, v2, v7, v4}, Ld/m/f/e/r;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-direct {p0, v1, v3, v2, v4}, Ld/m/f/e/r;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method private h0(Ld/m/f/e/h0;)V
    .locals 7
    .param p1    # Ld/m/f/e/h0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v4, v5}, Ld/m/f/a/e;->b(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v1, v2, v5, v4}, Ld/m/f/e/r;->f0(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public X(Ld/m/f/e/h0;)V
    ...
    invoke-virtual {p1}, Ld/m/f/e/h0;->f()Le/c;
    ...
    :cond_1
    invoke-direct {p0, p1}, Ld/m/f/e/r;->g0(Ld/m/f/e/h0;)V

    goto :goto_1

    :cond_2
    :goto_0
    invoke-direct {p0, p1}, Ld/m/f/e/r;->h0(Ld/m/f/e/h0;)V
...
.method public b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/List;
    ...
    iput-object v1, p0, Ld/m/f/e/n;->P:Landroid/media/ImageReader;

    new-instance v2, Ld/m/f/e/r$a;

    invoke-direct {v2, p0}, Ld/m/f/e/r$a;-><init>(Ld/m/f/e/r;)V
    ...
    iget-object v2, p0, Ld/m/f/e/n;->P:Landroid/media/ImageReader;
    ...
    iget-boolean v1, p0, Ld/m/f/e/r;->W:Z
    ...
    iput-object v1, p0, Ld/m/f/e/n;->Q:Landroid/media/ImageReader;

    new-instance v2, Ld/m/f/e/r$b;

    invoke-direct {v2, p0}, Ld/m/f/e/r$b;-><init>(Ld/m/f/e/r;)V
    ...
    iget-object v2, p0, Ld/m/f/e/n;->Q:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Ld/m/f/e/n;->R:Landroid/media/ImageReader;

    new-instance v1, Ld/m/f/e/r$c;

    invoke-direct {v1, p0}, Ld/m/f/e/r$c;-><init>(Ld/m/f/e/r;)V
    ...
    iget-object p0, p0, Ld/m/f/e/n;->R:Landroid/media/ImageReader;
...
.method public p()Z
    ...
    iget-boolean v0, p0, Ld/m/f/e/r;->W:Z
    ...
    iget-object v1, p0, Ld/m/f/e/v;->o:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Ld/m/f/e/v;->o:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Ld/m/f/e/v;->p:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Ld/m/f/e/v;->q:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v0, p0}, Ld/m/f/e/v$a;->f(Ld/m/f/e/v;)Z
    ...
    iget-object p0, p0, Ld/m/f/e/v;->o:Ljava/util/concurrent/atomic/AtomicInteger;
