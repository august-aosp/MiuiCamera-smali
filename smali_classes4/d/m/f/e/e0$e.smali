.class public Ld/m/f/e/e0$e;
.super Ljava/lang/Object;
.source "PostProcessor.java"

# interfaces
.implements Ld/m/f/e/v$a;
...
.method public constructor <init>(Ld/m/f/e/e0;)V
    ...
    iput-object p1, p0, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;
...
.method private h(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLd/m/f/e/a0;J)V
    .locals 6
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-static {p2}, Ld/m/f/a/d;->f(Landroid/media/Image;)[B
    ...
    invoke-virtual {p4, v3, v0}, Ld/m/f/e/a0;->a([BI)V

    const-string p2, "JPEG"

    invoke-virtual {p4, p2}, Ld/m/f/e/a0;->a0(Ljava/lang/String;)Z

    move-result p2

    if-nez p2, :cond_2

    sget-boolean p2, Ld/m/f/e/e0;->p:Z
    ...
    invoke-virtual {p4, p2}, Ld/m/f/e/a0;->V0(Z)V
    ...
    iget-object p2, p0, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {p2}, Ld/m/f/e/e0;->n(Ld/m/f/e/e0;)Ld/c/a/k7/p;

    move-result-object p2

    const/4 p3, 0x0

    invoke-virtual {p2, p4, p1, p3, p3}, Ld/c/a/k7/p;->c(Ld/m/f/e/a0;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)Z

    move-result p1

    iget-object p2, p0, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-virtual {p4}, Ld/m/f/e/a0;->O()Landroid/media/Image;

    move-result-object p3

    invoke-static {p2, p3}, Ld/m/f/e/e0;->u(Ld/m/f/e/e0;Landroid/media/Image;)V

    if-eqz p1, :cond_3

    invoke-virtual {p4}, Ld/m/f/e/a0;->u0()V

    :cond_3
    iget-object p1, p0, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {p1, p4}, Ld/m/f/e/e0;->v(Ld/m/f/e/e0;Ld/m/f/e/a0;)Z
    ...
    invoke-interface {p1, p4}, Ld/m/f/e/e0$j;->a(Ld/m/f/e/a0;)V
    ...
    invoke-static {p1}, Ld/m/f/e/e0;->y(Ld/m/f/e/e0;)I

    iget-object p1, p0, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {p1, p5, p6}, Ld/m/f/e/e0;->i(Ld/m/f/e/e0;J)Ld/m/f/e/a0;

    move-result-object p1

    iget-object p2, p0, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {p2}, Ld/m/f/e/e0;->w(Ld/m/f/e/e0;)I

    move-result p3

    invoke-static {p2, p1, p3}, Ld/m/f/e/e0;->z(Ld/m/f/e/e0;Ld/m/f/e/a0;I)Z
    ...
    invoke-static {p1}, Ld/m/f/e/e0;->A(Ld/m/f/e/e0;)V

    iget-object p1, p0, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {p1, v0}, Ld/m/f/e/e0;->x(Ld/m/f/e/e0;I)I

    :cond_5
    iget-object p1, p0, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {p1}, Ld/m/f/e/e0;->C(Ld/m/f/e/e0;)V

    iget-object p0, p0, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {p0}, Ld/m/f/e/e0;->g(Ld/m/f/e/e0;)V
...
.method private i(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {p0, v0, v1}, Ld/m/f/e/e0$e;->g(J)Ld/m/f/e/a0;
    ...
    invoke-static {p1}, Ld/m/f/e/w;->a(Lcom/xiaomi/engine/ResultData;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Ld/m/f/e/d0;->F(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Ld/m/f/e/b0;->U0(B)V

    invoke-virtual {v0, p1}, Ld/m/f/e/d0;->d0(B)V
...
.method private j(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-virtual {v1, v2, v3}, Ld/m/f/e/e0$e;->g(J)Ld/m/f/e/a0;
    ...
    :goto_1
    iget-object v11, v1, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {v11}, Ld/m/f/e/e0;->r(Ld/m/f/e/e0;)Ljava/util/Map;
    ...
    invoke-static {v11, v12}, Ld/m/f/e/e0;->s(Ld/m/f/e/e0;Ljava/util/Map;)Ljava/util/Map;
    ...
    iget-object v0, v1, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {v0}, Ld/m/f/e/e0;->p(Ld/m/f/e/e0;)Ljava/util/Map;
    ...
    invoke-static {v0, v7}, Ld/m/f/e/e0;->q(Ld/m/f/e/e0;Ljava/util/Map;)Ljava/util/Map;
    ...
    iget-object v7, v1, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {v7}, Ld/m/f/e/e0;->r(Ld/m/f/e/e0;)Ljava/util/Map;
    ...
    invoke-virtual {v4}, Ld/m/f/e/a0;->J()I

    move-result v8

    invoke-virtual {v4}, Ld/m/f/e/a0;->I()I

    move-result v11

    invoke-virtual {v4}, Ld/m/f/e/a0;->d()Landroid/graphics/Rect;

    move-result-object v12

    invoke-virtual {v4}, Ld/m/f/e/a0;->P()F

    move-result v4

    invoke-static {v7, v8, v11, v12, v4}, Ld/c/a/m5;->E(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)Z
    ...
    invoke-static {v0}, Ld/m/f/e/e0;->r(Ld/m/f/e/e0;)Ljava/util/Map;
    ...
    :try_start_1
    iget-object v4, v1, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {v4}, Ld/m/f/e/e0;->j(Ld/m/f/e/e0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-static {v4}, Ld/m/f/e/e0;->p(Ld/m/f/e/e0;)Ljava/util/Map;
    ...
    iget-object v1, v1, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {v1}, Ld/m/f/e/e0;->r(Ld/m/f/e/e0;)Ljava/util/Map;
...
.method public a(ILjava/lang/Object;)V
    ...
    invoke-direct {p0, p2}, Ld/m/f/e/e0$e;->i(Lcom/xiaomi/engine/ResultData;)V
    ...
    invoke-direct {p0, p2}, Ld/m/f/e/e0$e;->j(Lcom/xiaomi/engine/ResultData;)V
...
.method public b(Landroid/media/Image;)V
    ...
    invoke-static {p0}, Ld/m/f/e/e0;->f(Ld/m/f/e/e0;)Ld/m/f/e/q;

    move-result-object p0

    invoke-interface {p0, p1}, Ld/m/f/e/q;->b(Landroid/media/Image;)V
...
.method public c(Landroid/media/Image;IZ)V
    ...
    invoke-static {v8, v14}, Ld/m/f/a/e;->d(II)V

    invoke-static/range {p1 .. p1}, Ld/m/f/a/d;->g(Landroid/media/Image;)[B
    ...
    invoke-static {v1}, Ld/m/f/e/e0;->j(Ld/m/f/e/e0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    :cond_0
    invoke-virtual {v1, v9, v10}, Ld/m/f/e/e0$e;->g(J)Ld/m/f/e/a0;
    ...
    invoke-virtual {v15}, Ld/m/f/e/a0;->l()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v15}, Ld/m/f/e/a0;->s()Ld/m/f/e/b0;

    move-result-object v3

    const v4, 0x48454946

    invoke-virtual {v3}, Ld/m/f/e/b0;->o0()I
    ...
    :goto_0
    invoke-virtual {v15}, Ld/m/f/e/a0;->e()I
    ...
    invoke-static {v5}, Ld/m/f/a/c;->d(I)Z

    move-result v4

    if-nez v4, :cond_8

    invoke-virtual {v3}, Ld/m/f/e/b0;->R0()Z
    ...
    iget-object v2, v1, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;
    ...
    invoke-static/range {v2 .. v7}, Ld/m/f/e/e0;->k(Ld/m/f/e/e0;Ld/m/f/e/a0;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    invoke-static {v3, v0, v7}, Ld/m/f/a/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v3

    iget-object v4, v1, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {v4}, Ld/m/f/e/e0;->f(Ld/m/f/e/e0;)Ld/m/f/e/q;

    move-result-object v4

    invoke-interface {v4, v0}, Ld/m/f/e/q;->b(Landroid/media/Image;)V
    ...
    iget-object v3, v1, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {v3}, Ld/m/f/e/e0;->n(Ld/m/f/e/e0;)Ld/c/a/k7/p;

    move-result-object v3

    iget-object v4, v1, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {v4}, Ld/m/f/e/e0;->l(Ld/m/f/e/e0;)Ld/c/a/k7/n$a;

    move-result-object v4

    invoke-virtual {v3, v0, v2, v15, v4}, Ld/c/a/k7/p;->s(Landroid/media/Image;Landroid/hardware/camera2/CaptureResult;Ld/m/f/e/a0;Ld/c/a/k7/n$a;)V

    invoke-static {v5}, Ld/m/f/a/c;->c(I)Z
    ...
    invoke-static {v0}, Ld/m/f/e/e0;->o(Ld/m/f/e/e0;)Ljava/util/Map;
    ...
    invoke-static {v3}, Ld/m/f/e/e0;->p(Ld/m/f/e/e0;)Ljava/util/Map;
    ...
    invoke-static {v3, v5}, Ld/m/f/e/e0;->q(Ld/m/f/e/e0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v3}, Ld/m/f/e/e0;->r(Ld/m/f/e/e0;)Ljava/util/Map;
    ...
    invoke-static {v3, v5}, Ld/m/f/e/e0;->s(Ld/m/f/e/e0;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-virtual {v15}, Ld/m/f/e/a0;->J()I

    move-result v5

    invoke-virtual {v15}, Ld/m/f/e/a0;->I()I

    move-result v6

    invoke-virtual {v15}, Ld/m/f/e/a0;->d()Landroid/graphics/Rect;

    move-result-object v7

    invoke-virtual {v15}, Ld/m/f/e/a0;->P()F

    move-result v8

    invoke-static {v3, v5, v6, v7, v8}, Ld/c/a/m5;->E(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)Z
    ...
    invoke-static {v2}, Ld/m/f/e/e0;->j(Ld/m/f/e/e0;)Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-static {v2}, Ld/m/f/e/e0;->r(Ld/m/f/e/e0;)Ljava/util/Map;
    ...
    invoke-static {v1}, Ld/m/f/e/e0;->p(Ld/m/f/e/e0;)Ljava/util/Map;
    ...
    invoke-direct/range {v1 .. v7}, Ld/m/f/e/e0$e;->h(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLd/m/f/e/a0;J)V
    ...
    invoke-virtual {v4}, Ld/m/f/e/b0;->F0()Z
    ...
    invoke-static {v2, v0, v3}, Ld/m/f/a/d;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v2

    iget-object v3, v1, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {v3}, Ld/m/f/e/e0;->f(Ld/m/f/e/e0;)Ld/m/f/e/q;

    move-result-object v3

    invoke-interface {v3, v0}, Ld/m/f/e/q;->b(Landroid/media/Image;)V

    iget-object v0, v1, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {v0, v9, v10, v2}, Ld/m/f/e/e0;->t(Ld/m/f/e/e0;JLandroid/media/Image;)V
    ...
    invoke-static {v1, v9, v10, v0}, Ld/m/f/e/e0;->t(Ld/m/f/e/e0;JLandroid/media/Image;)V
...
.method public e(JI)V
    ...
    iget-object v0, p0, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {v0}, Ld/m/f/e/e0;->m(Ld/m/f/e/e0;)Ld/m/f/e/e0$j;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, p1, p2}, Ld/m/f/e/e0$e;->g(J)Ld/m/f/e/a0;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Ld/m/f/e/a0;->i0()Z
    ...
    invoke-virtual {v0}, Ld/m/f/e/a0;->e()I
    ...
    invoke-virtual {v1, p1}, Ld/c/a/u6/n;->T(Ljava/lang/String;)V

    iget-object p0, p0, Ld/m/f/e/e0$e;->a:Ld/m/f/e/e0;

    invoke-static {p0}, Ld/m/f/e/e0;->m(Ld/m/f/e/e0;)Ld/m/f/e/e0$j;

    move-result-object p0

    invoke-interface {p0, v0, p3}, Ld/m/f/e/e0$j;->b(Ld/m/f/e/a0;I)V
...
.method public f(Ld/m/f/e/v;)Z
    ...
    invoke-virtual {p0, p1}, Ld/m/f/e/z;->w(Ld/m/f/e/v;)Z
...
.method public g(J)Ld/m/f/e/a0;
    ...
    invoke-static {p0, p1, p2}, Ld/m/f/e/e0;->K(Ld/m/f/e/e0;J)Ld/m/f/e/a0;
