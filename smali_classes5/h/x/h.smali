...
.field private G8:Landroid/view/View$OnTouchListener;

.field private H8:Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;

.field private I8:Landroid/graphics/Paint;
...
.method public static constructor <clinit>()V
    ...
    sget v5, Lh/x/i$d;->state_no_title:I

    const/4 v8, 0x4

    aput v5, v0, v8

    sput-object v0, Lh/x/h;->c:[I
    ...
    sput-object v0, Lh/x/h;->m:[I

    new-array v0, v3, [I

    aput v4, v0, v1

    sput-object v0, Lh/x/h;->n:[I

    new-array v0, v3, [I

    aput v6, v0, v1

    sput-object v0, Lh/x/h;->p:[I

    new-array v0, v3, [I

    aput v7, v0, v1

    sput-object v0, Lh/x/h;->s:[I

    new-array v0, v3, [I

    aput v5, v0, v1

    sput-object v0, Lh/x/h;->t:[I
...
.method public constructor <init>(Landroidx/preference/PreferenceGroup;)V
    ...
    new-instance v0, Lh/x/h$a;

    invoke-direct {v0, p0}, Lh/x/h$a;-><init>(Lh/x/h;)V

    iput-object v0, p0, Lh/x/h;->w:Landroidx/recyclerview/widget/RecyclerView$AdapterDataObserver;

    const/4 v0, 0x0

    iput v0, p0, Lh/x/h;->C1:I

    iput v0, p0, Lh/x/h;->K1:I

    iput-boolean v0, p0, Lh/x/h;->v2:Z

    const/4 v1, -0x1

    iput v1, p0, Lh/x/h;->C2:I

    const/4 v1, 0x0

    iput-object v1, p0, Lh/x/h;->K2:Landroid/view/View;

    iput-boolean v0, p0, Lh/x/h;->F8:Z

    iput-object v1, p0, Lh/x/h;->G8:Landroid/view/View$OnTouchListener;

    iput-object v1, p0, Lh/x/h;->H8:Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;
    ...
    iput-object v0, p0, Lh/x/h;->u:[Lh/x/h$e;

    invoke-virtual {p1}, Landroidx/preference/Preference;->getContext()Landroid/content/Context;

    move-result-object p1

    invoke-virtual {p0, p1}, Lh/x/h;->y(Landroid/content/Context;)V
...
.method private H(Landroid/view/View;)V
    ...
    sget v0, Lh/x/i$j;->preference_highlighted:I
    ...
    iput-object p1, p0, Lh/x/h;->K2:Landroid/view/View;
...
.method private K(Landroidx/preference/Preference;)V
    ...
    iget-object v0, p0, Lh/x/h;->v1:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-direct {p0, p1}, Lh/x/h;->q(Lmiuix/preference/RadioButtonPreferenceCategory;)V
    ...
    invoke-direct {p0, p1}, Lh/x/h;->r(Lmiuix/preference/RadioSetPreferenceCategory;)V
...
.method private h(Landroidx/preference/Preference;)Z
    ...
    instance-of p0, p1, Lh/x/d;

    if-eqz p0, :cond_0

    check-cast p1, Lh/x/d;

    invoke-interface {p1}, Lh/x/d;->a()Z
...
.method public static synthetic i(Lh/x/h;[Lh/x/h$e;)[Lh/x/h$e;
    .locals 0

    iput-object p1, p0, Lh/x/h;->u:[Lh/x/h$e;

    return-object p1
.end method

.method public static synthetic j(Lh/x/h;)Landroid/view/View;
    .locals 0

    iget-object p0, p0, Lh/x/h;->K2:Landroid/view/View;

    return-object p0
.end method

.method public static synthetic k(Lh/x/h;)Z
    .locals 0

    iget-boolean p0, p0, Lh/x/h;->F8:Z

    return p0
.end method

.method public static synthetic l(Lh/x/h;Z)Z
    .locals 0

    iput-boolean p1, p0, Lh/x/h;->F8:Z

    return p1
.end method

.method public static synthetic m(Lh/x/h;)I
    .locals 0

    iget p0, p0, Lh/x/h;->C2:I

    return p0
.end method

.method public static synthetic n(Lh/x/h;I)I
    .locals 0

    iput p1, p0, Lh/x/h;->C2:I
...
.method private p(Landroid/graphics/drawable/Drawable;ZZ)V
    ...
    iget-object v2, p0, Lh/x/h;->I8:Landroid/graphics/Paint;

    iget v3, p0, Lh/x/h;->J8:I

    iget v4, p0, Lh/x/h;->K8:I

    iget v5, p0, Lh/x/h;->L8:I

    iget v6, p0, Lh/x/h;->M8:I

    iget v7, p0, Lh/x/h;->N8:I
    ...
    iget-object v1, p0, Lh/x/h;->v1:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {p0, v1, v0}, Lh/x/h;->v(Landroidx/recyclerview/widget/RecyclerView;Z)Landroid/util/Pair;
...
.method private q(Lmiuix/preference/RadioButtonPreferenceCategory;)V
    ...
    invoke-direct {p0, v2}, Lh/x/h;->r(Lmiuix/preference/RadioSetPreferenceCategory;)V
...
.method private r(Lmiuix/preference/RadioSetPreferenceCategory;)V
    ...
    iget-object v4, p0, Lh/x/h;->v1:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_1
    invoke-direct {p0, v1}, Lh/x/h;->t(Ljava/util/List;)V
...
.method private s(Landroid/view/View;ZZ)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lh/x/h;->p(Landroid/graphics/drawable/Drawable;ZZ)V
...
.method private t(Ljava/util/List;)V
    ...
    invoke-direct {p0, v4, v3, v2}, Lh/x/h;->s(Landroid/view/View;ZZ)V
...
.method private x(Landroidx/preference/Preference;I)V
    ...
    iget-object v0, p0, Lh/x/h;->u:[Lh/x/h$e;
    ...
    new-instance v1, Lh/x/h$e;

    invoke-direct {v1, p0}, Lh/x/h$e;-><init>(Lh/x/h;)V
    ...
    iget-object v0, v0, Lh/x/h$e;->a:[I
    ...
    invoke-direct {p0, v0}, Lh/x/h;->u(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    :cond_6
    iget-object p0, p0, Lh/x/h;->u:[Lh/x/h$e;

    aget-object p1, p0, p2

    iput-object v0, p1, Lh/x/h$e;->a:[I

    aget-object p0, p0, p2

    iput v2, p0, Lh/x/h$e;->b:I
...
.method public B(Landroidx/preference/PreferenceViewHolder;)V
    ...
    invoke-virtual {p0, p1}, Lh/x/h;->J(Landroid/view/View;)V
...
.method public D(Landroidx/recyclerview/widget/RecyclerView;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lh/x/h;->G8:Landroid/view/View$OnTouchListener;

    if-nez v1, :cond_2

    new-instance v1, Lh/x/h$b;

    invoke-direct {v1, p0}, Lh/x/h$b;-><init>(Lh/x/h;)V

    iput-object v1, p0, Lh/x/h;->G8:Landroid/view/View$OnTouchListener;

    :cond_2
    iget-object v1, p0, Lh/x/h;->H8:Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;

    if-nez v1, :cond_3

    new-instance v1, Lh/x/h$c;

    invoke-direct {v1, p0}, Lh/x/h$c;-><init>(Lh/x/h;)V
    ...
    new-instance v0, Lh/x/h$d;

    invoke-direct {v0, p0, p2}, Lh/x/h$d;-><init>(Lh/x/h;I)V
...
.method public E(Landroid/graphics/Paint;IIIII)V
    ...
    iput-object p1, p0, Lh/x/h;->I8:Landroid/graphics/Paint;

    iput p2, p0, Lh/x/h;->J8:I

    iput p3, p0, Lh/x/h;->K8:I

    iput p4, p0, Lh/x/h;->L8:I

    iput p5, p0, Lh/x/h;->M8:I

    iput p6, p0, Lh/x/h;->N8:I
...
.method public F(IIZ)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lh/x/h;->G(IIZZ)V
...
.method public G(IIZZ)V
    ...
    iget p4, p0, Lh/x/h;->C1:I

    if-eq p4, p1, :cond_1

    :cond_0
    iput p1, p0, Lh/x/h;->C1:I

    iput p2, p0, Lh/x/h;->K1:I

    iput-boolean p3, p0, Lh/x/h;->v2:Z
...
.method public I()V
    ...
    iget-object v0, p0, Lh/x/h;->K2:Landroid/view/View;

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0}, Lh/x/h;->J(Landroid/view/View;)V
...
.method public J(Landroid/view/View;)V
    ...
    sget v1, Lh/x/i$j;->preference_highlighted:I
    ...
    iget-object p1, p0, Lh/x/h;->v1:Landroidx/recyclerview/widget/RecyclerView;

    if-eqz p1, :cond_2

    iget-object v0, p0, Lh/x/h;->H8:Landroidx/recyclerview/widget/RecyclerView$OnItemTouchListener;
...
.method public o(Landroidx/preference/PreferenceViewHolder;I)V
    ...
    iget v0, p0, Lh/x/h;->C2:I

    if-ne p2, v0, :cond_2

    iget-boolean p2, p0, Lh/x/h;->F8:Z
    ...
    :cond_0
    invoke-direct {p0, p1}, Lh/x/h;->H(Landroid/view/View;)V
...
.method public onAttachedToRecyclerView(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iget-object v0, p0, Lh/x/h;->w:Landroidx/recyclerview/widget/RecyclerView$AdapterDataObserver;
    ...
    iput-object p1, p0, Lh/x/h;->v1:Landroidx/recyclerview/widget/RecyclerView;
...
.method public onBindViewHolder(Landroidx/preference/PreferenceViewHolder;I)V
    ...
    :cond_0
    invoke-direct {p0, v0, p2}, Lh/x/h;->x(Landroidx/preference/Preference;I)V

    iget-object v4, p0, Lh/x/h;->u:[Lh/x/h$e;

    aget-object v4, v4, p2

    iget-object v4, v4, Lh/x/h$e;->a:[I
    ...
    :cond_1
    iget-boolean v2, p0, Lh/x/h;->v2:Z

    if-eqz v2, :cond_2

    iget v2, p0, Lh/x/h;->C1:I
    ...
    iget-object v7, p0, Lh/x/h;->v1:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :goto_2
    iget-object v6, p0, Lh/x/h;->v1:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget v4, p0, Lh/x/h;->K0:I

    goto :goto_3

    :cond_9
    iget v4, p0, Lh/x/h;->k1:I
    ...
    iget-boolean v6, p0, Lh/x/h;->v2:Z

    if-eqz v6, :cond_f

    iget v7, p0, Lh/x/h;->K1:I
    ...
    sget v3, Lh/x/i$j;->arrow_right:I
    ...
    invoke-direct {p0, v0}, Lh/x/h;->z(Landroidx/preference/Preference;)Z
    ...
    :cond_14
    invoke-direct {p0, v0}, Lh/x/h;->h(Landroidx/preference/Preference;)Z
    ...
    invoke-static {v0}, Lh/l/c/c;->a(Landroid/view/View;)V
    ...
    invoke-static {v0}, Lh/b/e/d/e;->b(Landroid/widget/TextView;)V

    invoke-virtual {p0, p1, p2}, Lh/x/h;->o(Landroidx/preference/PreferenceViewHolder;I)V
...
.method public bridge synthetic onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lh/x/h;->onBindViewHolder(Landroidx/preference/PreferenceViewHolder;I)V
...
.method public onDetachedFromRecyclerView(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iget-object p1, p0, Lh/x/h;->w:Landroidx/recyclerview/widget/RecyclerView$AdapterDataObserver;
...
.method public onPreferenceVisibilityChange(Landroidx/preference/Preference;)V
    ...
    invoke-direct {p0, p1}, Lh/x/h;->K(Landroidx/preference/Preference;)V
...
.method public bridge synthetic onViewDetachedFromWindow(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p0, p1}, Lh/x/h;->B(Landroidx/preference/PreferenceViewHolder;)V
...
.method public bridge synthetic onViewRecycled(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p0, p1}, Lh/x/h;->C(Landroidx/preference/PreferenceViewHolder;)V
...
.method public y(Landroid/content/Context;)V
    ...
    sget v0, Lh/x/i$d;->preferenceRadioSetChildExtraPaddingStart:I

    invoke-static {p1, v0}, Lh/l/c/d;->h(Landroid/content/Context;I)I

    move-result v0

    iput v0, p0, Lh/x/h;->k0:I

    sget v0, Lh/x/i$d;->checkablePreferenceItemColorFilterChecked:I

    invoke-static {p1, v0}, Lh/l/c/d;->e(Landroid/content/Context;I)I

    move-result v0

    iput v0, p0, Lh/x/h;->K0:I

    sget v0, Lh/x/i$d;->checkablePreferenceItemColorFilterNormal:I

    invoke-static {p1, v0}, Lh/l/c/d;->e(Landroid/content/Context;I)I

    move-result p1

    iput p1, p0, Lh/x/h;->k1:I
