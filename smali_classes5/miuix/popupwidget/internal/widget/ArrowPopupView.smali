...
.field private F8:Landroidx/appcompat/widget/AppCompatTextView;

.field private G8:Landroidx/appcompat/widget/AppCompatButton;

.field private H8:Landroidx/appcompat/widget/AppCompatButton;

.field private I8:Lmiuix/popupwidget/internal/widget/ArrowPopupView$h;

.field private J8:Lmiuix/popupwidget/internal/widget/ArrowPopupView$h;
...
.field private N8:Landroid/graphics/drawable/Drawable;

.field private O8:Landroid/graphics/drawable/Drawable;

.field private P8:Landroid/graphics/drawable/Drawable;

.field private Q8:Landroid/graphics/drawable/Drawable;
...
.field private Z8:Lh/w/c/a;

.field private a9:Landroid/view/View$OnTouchListener;

.field private b9:Landroid/graphics/Rect;

.field private c9:Landroid/graphics/RectF;

.field private d9:Landroid/animation/AnimatorSet;

.field private e9:Landroid/view/animation/AnimationSet;
...
.field private q9:Landroid/view/animation/Animation$AnimationListener;

.field private r9:Landroid/view/animation/Animation$AnimationListener;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Lh/w/b$b;->arrowPopupViewStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->b9:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->c9:Landroid/graphics/RectF;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->g9:Z

    const/4 v1, 0x2

    iput v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->h9:I

    const/4 v1, 0x0

    iput-boolean v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->n9:Z
    ...
    iput-object v2, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->q9:Landroid/view/animation/Animation$AnimationListener;
    ...
    iput-object v2, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->r9:Landroid/view/animation/Animation$AnimationListener;

    iput v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->s9:I

    invoke-static {p0, v1}, Lh/j0/c;->b(Landroid/view/View;Z)V

    iput-boolean v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->g9:Z

    sget-object v0, Lh/w/b$n;->ArrowPopupView:[I

    sget v1, Lh/w/b$m;->Widget_ArrowPopupView_DayNight:I

    invoke-virtual {p1, p2, v0, p3, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p2

    sget p3, Lh/w/b$n;->ArrowPopupView_contentBackground:I

    invoke-virtual {p2, p3}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    iput-object p3, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->M8:Landroid/graphics/drawable/Drawable;

    sget p3, Lh/w/b$n;->ArrowPopupView_backgroundLeft:I

    invoke-virtual {p2, p3}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    iput-object p3, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->N8:Landroid/graphics/drawable/Drawable;

    sget p3, Lh/w/b$n;->ArrowPopupView_backgroundRight:I

    invoke-virtual {p2, p3}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    iput-object p3, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->O8:Landroid/graphics/drawable/Drawable;

    sget p3, Lh/w/b$n;->ArrowPopupView_titleBackground:I

    invoke-virtual {p2, p3}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    iput-object p3, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->P8:Landroid/graphics/drawable/Drawable;

    sget p3, Lh/w/b$n;->ArrowPopupView_topArrow:I

    invoke-virtual {p2, p3}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    iput-object p3, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->Q8:Landroid/graphics/drawable/Drawable;

    sget p3, Lh/w/b$n;->ArrowPopupView_topArrowWithTitle:I
    ...
    sget p3, Lh/w/b$n;->ArrowPopupView_bottomArrow:I
    ...
    sget p3, Lh/w/b$n;->ArrowPopupView_rightArrow:I
    ...
    sget p3, Lh/w/b$n;->ArrowPopupView_leftArrow:I
    ...
    sget p3, Lh/w/b$n;->ArrowPopupView_topLeftArrow:I
    ...
    sget p3, Lh/w/b$n;->ArrowPopupView_topRightArrow:I
    ...
    sget p3, Lh/w/b$n;->ArrowPopupView_bottomRightArrow:I
    ...
    sget p3, Lh/w/b$n;->ArrowPopupView_bottomLeftArrow:I
    ...
    sget v0, Lh/w/b$e;->miuix_appcompat_arrow_popup_window_elevation:I

    invoke-virtual {p3, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result p3

    sget v0, Lh/w/b$n;->ArrowPopupView_android_elevation:I

    invoke-virtual {p2, v0, p3}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result p3

    iput p3, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->p9:I
    ...
    sget p2, Lh/w/b$e;->miuix_appcompat_arrow_popup_window_min_border:I

    invoke-virtual {p1, p2}, Landroid/content/res/Resources;->getDimensionPixelOffset(I)I

    move-result p1

    iput p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->i9:I
...
.method private A([F)V
    ...
    iget v4, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->h9:I
    ...
    :goto_1
    iget p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->s9:I
...
.method private N(I)V
    ...
    iget v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->h9:I
    ...
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->S8:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->R8:Landroid/graphics/drawable/Drawable;

    goto :goto_5

    :cond_6
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->Q8:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->U8:Landroid/graphics/drawable/Drawable;
...
.method public static synthetic a(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)Landroid/view/animation/AnimationSet;
    ...
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->e9:Landroid/view/animation/AnimationSet;
...
.method public static synthetic b(Lmiuix/popupwidget/internal/widget/ArrowPopupView;Landroid/view/animation/AnimationSet;)Landroid/view/animation/AnimationSet;
    ...
    iput-object p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->e9:Landroid/view/animation/AnimationSet;
...
.method public static synthetic c(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)Z
    ...
    iget-boolean p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->n9:Z
...
.method public static synthetic d(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)Landroid/view/animation/Animation$AnimationListener;
    ...
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->q9:Landroid/view/animation/Animation$AnimationListener;
...
.method public static synthetic e(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)I
    ...
    iget p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->o9:I
...
.method public static synthetic f(Lmiuix/popupwidget/internal/widget/ArrowPopupView;I)I
    ...
    iput p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->o9:I
...
.method private getArrowHeight()I
    ...
    iget v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->s9:I
...
.method public static synthetic i(Lmiuix/popupwidget/internal/widget/ArrowPopupView;Z)Z
    ...
    iput-boolean p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->f9:Z

    return p1
.end method

.method public static synthetic j(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)Lh/w/c/a;
    .locals 0

    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->Z8:Lh/w/c/a;
...
.method public static synthetic l(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)I
    ...
    iget p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->h9:I
...
.method public static synthetic n(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)Landroid/animation/AnimatorSet;
    ...
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->d9:Landroid/animation/AnimatorSet;
...
.method private q(Landroid/view/View;Landroid/view/ViewOutlineProvider;)V
    ...
    iget p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->p9:I
...
.method private r()V
    ...
    iget v4, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->i9:I
...
.method private s()V
    ...
    iget-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->e9:Landroid/view/animation/AnimationSet;
    ...
    :cond_0
    iget-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->d9:Landroid/animation/AnimatorSet;
    ...
    iput-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->d9:Landroid/animation/AnimatorSet;
    ...
    iget v2, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->h9:I
    ...
    :goto_1
    iget v6, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->s9:I
    ...
    iget-boolean v7, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->g9:Z
    ...
    iget-boolean v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->g9:Z
    ...
    :goto_4
    iget-object v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->d9:Landroid/animation/AnimatorSet;
...
.method private v(I)V
    ...
    iput v15, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k9:I
    ...
    iput v6, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->m9:I
    ...
    iput v8, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
    ...
    iget v8, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->h9:I
    ...
    :cond_0
    iget v1, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
    ...
    iput v1, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
    ...
    :goto_5
    iget v1, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k9:I
    ...
    iget v2, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->L8:I

    add-int/2addr v1, v2

    iput v1, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k9:I
    ...
    iget v1, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->L8:I

    iput v1, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k9:I

    :cond_8
    :goto_6
    iget v1, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->m9:I

    iget v2, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->L8:I

    add-int/2addr v1, v2

    iput v1, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->m9:I

    if-gez v1, :cond_9

    const/4 v2, 0x0

    iput v2, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->m9:I
    ...
    iget v2, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
    ...
    iget v4, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k9:I

    invoke-static {v4, v3}, Ljava/lang/Math;->max(II)I

    move-result v3

    iget v4, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
    ...
    iget v5, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k9:I
    ...
    iget v0, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->m9:I
...
.method private w()V
    ...
    :cond_1
    :goto_0
    iget v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->K8:I
...
.method private x(I)V
    ...
    iput v15, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
    ...
    iput v12, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->l9:I

    invoke-virtual/range {p0 .. p0}, Landroid/widget/FrameLayout;->getTop()I

    move-result v1

    iget v9, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->L8:I
    ...
    iget v9, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
    ...
    iput v9, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
    ...
    iput v11, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
    ...
    iget v2, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->l9:I

    add-int v2, v2, p1

    iput v2, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->l9:I

    if-gez v2, :cond_5

    iput v11, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->l9:I
    ...
    iget v9, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k9:I

    invoke-static {v9, v11}, Ljava/lang/Math;->max(II)I

    move-result v9

    iget v10, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
...
.method private z(III)V
    ...
    :goto_1
    iget v3, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->s9:I
    ...
    iget p2, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->l9:I
    ...
    iget p3, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->s9:I
...
.method public B(I)[I
    ...
    :pswitch_2
    iget-object p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->S8:Landroid/graphics/drawable/Drawable;
    ...
    :pswitch_3
    iget-object p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->W8:Landroid/graphics/drawable/Drawable;
    ...
    :pswitch_5
    iget-object p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->Q8:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->T8:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->U8:Landroid/graphics/drawable/Drawable;
...
.method public G()Z
    ...
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->F8:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public K(Ljava/lang/CharSequence;Landroid/view/View$OnClickListener;)V
    ...
    iget-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->H8:Landroidx/appcompat/widget/AppCompatButton;
    ...
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->J8:Lmiuix/popupwidget/internal/widget/ArrowPopupView$h;
...
.method public L(II)V
    ...
    iput p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->K8:I

    iput p2, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->L8:I
...
.method public M(Ljava/lang/CharSequence;Landroid/view/View$OnClickListener;)V
    ...
    iget-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->G8:Landroidx/appcompat/widget/AppCompatButton;
    ...
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->I8:Lmiuix/popupwidget/internal/widget/ArrowPopupView$h;
...
.method public getNegativeButton()Landroidx/appcompat/widget/AppCompatButton;
    ...
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->H8:Landroidx/appcompat/widget/AppCompatButton;
...
.method public getPositiveButton()Landroidx/appcompat/widget/AppCompatButton;
    ...
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->G8:Landroidx/appcompat/widget/AppCompatButton;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->M8:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
    ...
    iget v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k9:I
    ...
    iget v2, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->s9:I
    ...
    iget v9, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->m9:I
    ...
    iget v10, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k9:I
    ...
    iget v11, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k9:I
    ...
    iget v9, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->l9:I
    ...
    iget v11, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
    ...
    :cond_4
    iget v2, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->l9:I
    ...
    iget v9, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->j9:I
    ...
    iget-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->N8:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->O8:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->O8:Landroid/graphics/drawable/Drawable;
...
.method public onFinishInflate()V
    ...
    sget v0, Lh/w/b$h;->popup_arrow:I
    ...
    sget v0, Lh/w/b$h;->content_wrapper:I
    ...
    iget-object v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->M8:Landroid/graphics/drawable/Drawable;
    ...
    sget v1, Lh/w/b$e;->miuix_appcompat_arrow_popup_view_min_height:I
    ...
    iget-object v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->N8:Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget v0, Lh/w/b$h;->title_layout:I
    ...
    iget-object v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->P8:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->F8:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iput-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->G8:Landroidx/appcompat/widget/AppCompatButton;
    ...
    iput-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->H8:Landroidx/appcompat/widget/AppCompatButton;
    ...
    iput-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->I8:Lmiuix/popupwidget/internal/widget/ArrowPopupView$h;

    new-instance v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView$h;

    invoke-direct {v0, p0}, Lmiuix/popupwidget/internal/widget/ArrowPopupView$h;-><init>(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)V

    iput-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->J8:Lmiuix/popupwidget/internal/widget/ArrowPopupView$h;

    iget-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->G8:Landroidx/appcompat/widget/AppCompatButton;

    iget-object v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->I8:Lmiuix/popupwidget/internal/widget/ArrowPopupView$h;
...
.method public onLayout(ZIIII)V
    ...
    iget-object p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->Z8:Lh/w/c/a;
    ...
    :cond_1
    iget p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->s9:I
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->b9:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v4}, Lh/w/c/a;->a(Z)V

    return v4

    :cond_0
    iget-object p0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->a9:Landroid/view/View$OnTouchListener;
...
.method public setArrowMode(I)V
    ...
    iput p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->s9:I
...
.method public setArrowPopupWindow(Lh/w/c/a;)V
    .locals 0

    iput-object p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->Z8:Lh/w/c/a;
...
.method public setAutoDismiss(Z)V
    ...
    iput-boolean p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->g9:Z
...
.method public setLayoutRtlMode(I)V
    ...
    iput p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->h9:I

    goto :goto_0

    :cond_0
    iput v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->h9:I
...
.method public setTouchInterceptor(Landroid/view/View$OnTouchListener;)V
    ...
    iput-object p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->a9:Landroid/view/View$OnTouchListener;
...
.method public t()V
    ...
    iget-boolean v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->f9:Z
    ...
    iput-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->e9:Landroid/view/animation/AnimationSet;
    ...
    :cond_3
    iget-object v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->e9:Landroid/view/animation/AnimationSet;
    ...
    iget-object v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->r9:Landroid/view/animation/Animation$AnimationListener;
...
.method public y(Z)V
    ...
    iput-boolean p1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->n9:Z
