...
.annotation runtime Lf/i0;
    ...
    d2 = {
        ...
        "Lokio/ZipFileSystem;",
        "openZip",
        "(Lokio/Path;Lokio/FileSystem;Lf/e3/x/l;)Lokio/ZipFileSystem;",
        "",
        "entries",
        "",
        "buildIndex",
        ...
        "block",
        "readExtra",
        "(Lokio/BufferedSource;ILf/e3/x/p;)V",
        "skipLocalHeader",
...
.method private static final buildIndex(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-static {v2, v1}, Lf/t2/e0;->p5(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
    ...
    invoke-direct/range {v4 .. v19}, Lokio/internal/ZipEntry;-><init>(Lokio/Path;ZLjava/lang/String;JJJILjava/lang/Long;JILf/e3/y/w;)V
...
.method private static final getHex(I)Ljava/lang/String;
    ...
    invoke-static {v0}, Lf/n3/d;->a(I)I
...
.method public static final openZip(Lokio/Path;Lokio/FileSystem;Lf/e3/x/l;)Lokio/ZipFileSystem;
    .locals 18
    .param p0    # Lokio/Path;
    ...
    invoke-static {v0, v3}, Lf/e3/y/l0;->p(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :cond_1
    sget-object v9, Lf/m2;->a:Lf/m2;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_7

    :try_start_3
    invoke-static {v8, v7}, Lf/b3/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    sget-object v10, Lf/m2;->a:Lf/m2;
    :try_end_7
    .catchall {:try_start_7 .. :try_end_7} :catchall_0

    :try_start_8
    invoke-static {v4, v7}, Lf/b3/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_8
    ...
    :try_start_b
    invoke-static {v4, v1}, Lf/b3/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :try_start_e
    invoke-static {v8, v1}, Lf/b3/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v2, v13}, Lf/e3/x/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v3, v7}, Lf/b3/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v1, v2}, Lf/e3/y/l0;->C(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v3, v1}, Lf/b3/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    throw v2
.end method

.method public static synthetic openZip$default(Lokio/Path;Lokio/FileSystem;Lf/e3/x/l;ILjava/lang/Object;)Lokio/ZipFileSystem;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lokio/internal/ZipKt;->openZip(Lokio/Path;Lokio/FileSystem;Lf/e3/x/l;)Lokio/ZipFileSystem;
...
.method public static final readEntry(Lokio/BufferedSource;)Lokio/internal/ZipEntry;
    ...
    new-instance v11, Lf/e3/y/k1$g;

    invoke-direct {v11}, Lf/e3/y/k1$g;-><init>()V
    ...
    iput-wide v2, v11, Lf/e3/y/k1$g;->c:J

    new-instance v14, Lf/e3/y/k1$g;

    invoke-direct {v14}, Lf/e3/y/k1$g;-><init>()V
    ...
    iput-wide v2, v14, Lf/e3/y/k1$g;->c:J
    ...
    new-instance v6, Lf/e3/y/k1$g;

    invoke-direct {v6}, Lf/e3/y/k1$g;-><init>()V
    ...
    iput-wide v1, v6, Lf/e3/y/k1$g;->c:J
    ...
    invoke-static {v2, v3, v3, v1, v0}, Lf/n3/c0;->V2(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z

    move-result v16

    if-nez v16, :cond_5

    iget-wide v0, v14, Lf/e3/y/k1$g;->c:J
    ...
    :goto_0
    iget-wide v5, v11, Lf/e3/y/k1$g;->c:J
    ...
    iget-wide v1, v6, Lf/e3/y/k1$g;->c:J
    ...
    new-instance v4, Lf/e3/y/k1$a;

    invoke-direct {v4}, Lf/e3/y/k1$a;-><init>()V
    ...
    invoke-direct/range {v0 .. v7}, Lokio/internal/ZipKt$readEntry$1;-><init>(Lf/e3/y/k1$a;JLf/e3/y/k1$g;Lokio/BufferedSource;Lf/e3/y/k1$g;Lf/e3/y/k1$g;)V

    invoke-static {v8, v15, v13}, Lokio/internal/ZipKt;->readExtra(Lokio/BufferedSource;ILf/e3/x/p;)V

    cmp-long v0, v20, v18

    if-lez v0, :cond_4

    iget-boolean v0, v12, Lf/e3/y/k1$a;->c:Z
    ...
    invoke-static {v9, v1, v4, v2, v3}, Lf/n3/b0;->K1(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z

    move-result v4

    new-instance v1, Lokio/internal/ZipEntry;

    iget-wide v8, v11, Lf/e3/y/k1$g;->c:J

    move-object/from16 v2, v25

    iget-wide v11, v2, Lf/e3/y/k1$g;->c:J

    iget-wide v14, v10, Lf/e3/y/k1$g;->c:J
    ...
    invoke-static {v2, v0}, Lf/e3/y/l0;->C(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method private static final readExtra(Lokio/BufferedSource;ILf/e3/x/p;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, v8, v9}, Lf/e3/x/p;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final readOrSkipLocalHeader(Lokio/BufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    ...
    new-instance v1, Lf/e3/y/k1$h;

    invoke-direct {v1}, Lf/e3/y/k1$h;-><init>()V
    ...
    :goto_0
    iput-object v3, v1, Lf/e3/y/k1$h;->c:Ljava/lang/Object;

    new-instance v3, Lf/e3/y/k1$h;

    invoke-direct {v3}, Lf/e3/y/k1$h;-><init>()V

    new-instance v4, Lf/e3/y/k1$h;

    invoke-direct {v4}, Lf/e3/y/k1$h;-><init>()V
    ...
    invoke-direct {v2, v0, v1, v3, v4}, Lokio/internal/ZipKt$readOrSkipLocalHeader$1;-><init>(Lokio/BufferedSource;Lf/e3/y/k1$h;Lf/e3/y/k1$h;Lf/e3/y/k1$h;)V

    invoke-static {v0, v5, v2}, Lokio/internal/ZipKt;->readExtra(Lokio/BufferedSource;ILf/e3/x/p;)V
    ...
    iget-object v2, v4, Lf/e3/y/k1$h;->c:Ljava/lang/Object;

    move-object v11, v2

    check-cast v11, Ljava/lang/Long;

    iget-object v1, v1, Lf/e3/y/k1$h;->c:Ljava/lang/Object;

    move-object v12, v1

    check-cast v12, Ljava/lang/Long;

    iget-object v1, v3, Lf/e3/y/k1$h;->c:Ljava/lang/Object;
    ...
    invoke-direct/range {v6 .. v16}, Lokio/FileMetadata;-><init>(ZZLokio/Path;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/util/Map;ILf/e3/y/w;)V
