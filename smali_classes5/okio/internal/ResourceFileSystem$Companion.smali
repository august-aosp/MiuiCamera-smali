...
.method private final keepPath(Lokio/Path;)Z
    ...
    invoke-static {p0, p1, v0}, Lf/n3/b0;->J1(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public final removeBase(Lokio/Path;Lokio/Path;)Lokio/Path;
    ...
    invoke-static {p1, p2}, Lf/n3/c0;->d4(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-static/range {v0 .. v5}, Lf/n3/b0;->k2(Ljava/lang/String;CCZILjava/lang/Object;)Ljava/lang/String;
...
.method public final toClasspathRoots(Ljava/lang/ClassLoader;)Ljava/util/List;
    ...
    invoke-virtual {v4, v2}, Lokio/internal/ResourceFileSystem$Companion;->toFileRoot(Ljava/net/URL;)Lf/u0;
    ...
    invoke-virtual {v2, v0}, Lokio/internal/ResourceFileSystem$Companion;->toJarRoot(Ljava/net/URL;)Lf/u0;
    ...
    :cond_3
    invoke-static {v1, p1}, Lf/t2/e0;->y4(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/List;
...
.method public final toFileRoot(Ljava/net/URL;)Lf/u0;
    .locals 4
...
.method public final toJarRoot(Ljava/net/URL;)Lf/u0;
    .locals 9
    .param p1    # Ljava/net/URL;
        .annotation build Lk/d/a/d;
        .end annotation
    ...
    invoke-static {p1, v0, v7, v1, v8}, Lf/n3/b0;->v2(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    invoke-static {p1, v0, v1}, Lokio/internal/ZipKt;->openZip(Lokio/Path;Lokio/FileSystem;Lf/e3/x/l;)Lokio/ZipFileSystem;
