...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    invoke-static {}, Lo/d$a;->a()Lo/d;

    move-result-object v2

    invoke-interface {v2}, Lo/d;->ay()Lo/j;

    move-result-object v3

    const-string v4, "_x0000_t136"

    invoke-interface {v3, v4}, Lo/j;->setId(Ljava/lang/String;)V

    const-string v4, "1600,21600"

    invoke-interface {v3, v4}, Lo/j;->R5(Ljava/lang/String;)V

    const/high16 v4, 0x43080000    # 136.0f

    invoke-interface {v3, v4}, Lo/j;->f7(F)V

    const-string v4, "10800"

    invoke-interface {v3, v4}, Lo/j;->C7(Ljava/lang/String;)V

    const-string v4, "m@7,0l@8,0m@5,21600l@6,21600e"

    invoke-interface {v3, v4}, Lo/j;->Z7(Ljava/lang/String;)V

    invoke-interface {v3}, Lo/j;->h3()Lo/c;

    move-result-object v4

    invoke-interface {v4}, Lo/c;->addNewF()Lo/a;

    move-result-object v5

    const-string/jumbo v6, "sum #0 0 10800"

    invoke-interface {v5, v6}, Lo/a;->Wa(Ljava/lang/String;)V
    ...
    invoke-interface {v4, v5}, Lo/a;->Wa(Ljava/lang/String;)V

    invoke-interface {v3}, Lo/j;->addNewPath()Lo/g;

    move-result-object v4

    sget-object v5, Lo/a0;->x8:Lo/a0$a;

    invoke-interface {v4, v5}, Lo/g;->fn(Lo/a0$a;)V

    sget-object v6, Ln/e;->K7:Ln/e$a;

    invoke-interface {v4, v6}, Lo/g;->fv(Ln/e$a;)V

    const-string v6, "@9,0;@10,10800;@11,21600;@12,10800"

    invoke-interface {v4, v6}, Lo/g;->Gw(Ljava/lang/String;)V

    const-string v6, "270,180,90,0"

    invoke-interface {v4, v6}, Lo/g;->cs(Ljava/lang/String;)V

    invoke-interface {v3}, Lo/j;->G4()Lo/l;

    move-result-object v4

    invoke-interface {v4, v5}, Lo/l;->u(Lo/a0$a;)V

    invoke-interface {v4, v5}, Lo/l;->Zs(Lo/a0$a;)V

    invoke-interface {v3}, Lo/j;->K2()Lo/f;

    move-result-object v4

    invoke-interface {v4}, Lo/f;->addNewH()Lo/e;

    move-result-object v4

    const-string v5, "#0,bottomRight"

    invoke-interface {v4, v5}, Lo/e;->setPosition(Ljava/lang/String;)V

    const-string v5, "6629,14971"

    invoke-interface {v4, v5}, Lo/e;->Fn(Ljava/lang/String;)V

    invoke-interface {v3}, Lo/j;->addNewLock()Ln/b;

    move-result-object v3

    sget-object v4, Lo/p;->k8:Lo/p$a;

    invoke-interface {v3, v4}, Ln/b;->Z5(Lo/p$a;)V

    invoke-interface {v2}, Lo/d;->Rv()Lo/i;
    ...
    invoke-interface {v3, v4}, Lo/i;->setId(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lo/i;->B0(Ljava/lang/String;)V

    const-string p2, "#_x0000_t136"

    invoke-interface {v3, p2}, Lo/i;->setType(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lo/i;->d(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p2}, Lo/i;->U2(Ljava/lang/String;)V

    const-string p2, "black"

    invoke-interface {v3, p2}, Lo/i;->I6(Ljava/lang/String;)V

    sget-object p2, Lo/a0;->A8:Lo/a0$a;

    invoke-interface {v3, p2}, Lo/i;->t7(Lo/a0$a;)V

    invoke-interface {v3}, Lo/i;->G4()Lo/l;

    move-result-object p2

    const-string v3, "font-family:&quot;Cambria&quot;;font-size:1pt"

    invoke-interface {p2, v3}, Lo/l;->d(Ljava/lang/String;)V

    invoke-interface {p2, p1}, Lo/l;->bF(Ljava/lang/String;)V
