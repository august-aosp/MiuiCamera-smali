...
.method private propName(S)Ljava/lang/String;
    ...
    const-string/jumbo v5, "transform.rotation"
    ...
    const-string/jumbo v15, "text.textid"
    ...
    const-string/jumbo v5, "text.textleft"
    ...
    const-string/jumbo v1, "text.texttop"
    ...
    const-string/jumbo v5, "text.textright"
    ...
    const-string/jumbo v3, "text.textbottom"
    ...
    const-string/jumbo v5, "text.wraptext"
    ...
    const-string/jumbo v3, "text.scaletext"
    ...
    const-string/jumbo v5, "text.anchortext"
    ...
    const-string/jumbo v3, "text.textflow"
    ...
    const-string/jumbo v5, "text.fontrotation"
    ...
    const-string/jumbo v3, "text.idofnextshape"
    ...
    const-string/jumbo v5, "text.bidir"
    ...
    const-string/jumbo v5, "text.singleclickselects"
    ...
    const-string/jumbo v5, "text.usehostmargins"
    ...
    const-string/jumbo v5, "text.rotatetextwithshape"
    ...
    const-string/jumbo v5, "text.sizeshapetofittext"
    ...
    const-string/jumbo v5, "text.sizetexttofitshape"
    ...
    const-string/jumbo v4, "shadowstyle.color"
    ...
    const-string/jumbo v4, "shadowstyle.crmod"
    ...
    const-string/jumbo v4, "shadowstyle.offsetx"
    ...
    const-string/jumbo v4, "shadowstyle.secondoffsetx"
    ...
    const-string/jumbo v4, "shadowstyle.scalextox"
    ...
    const-string/jumbo v4, "shadowstyle.scalextoy"
    ...
    const-string/jumbo v4, "shadowstyle.perspectivex"
    ...
    const-string/jumbo v4, "shadowstyle.weight"
    ...
    const-string/jumbo v4, "shadowstyle.originy"
    ...
    const-string/jumbo v4, "shadowstyle.shadowobsured"
    ...
    const-string/jumbo v4, "shape.connectorstyle"
    ...
    const-string/jumbo v4, "shape.wmodepurebw"
    ...
    const-string/jumbo v4, "shape.oleicon"
    ...
    const-string/jumbo v4, "shape.lockshapetype"
    ...
    const-string/jumbo v4, "shape.backgroundshape"
