...
.method private static a(Landroid/content/Context;)V
    ...
    sget v0, Lh/b/b$g;->miuix_appcompat_floating_window_background_radius:I
...
.method public static c(Landroid/content/Context;Landroid/view/View;Landroid/graphics/Bitmap;)Landroid/view/View;
    ...
    invoke-direct {v0, p0}, Lh/l/e/k;-><init>(Landroid/content/Context;)V
...
.method public static d(Landroid/content/Context;Lmiuix/appcompat/app/AppCompatActivity;)Landroid/view/View;
    ...
    invoke-static {p1}, Lh/b/d/s/l;->f(Landroid/view/View;)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-static {p0, p1, v0}, Lh/b/d/s/l;->c(Landroid/content/Context;Landroid/view/View;Landroid/graphics/Bitmap;)Landroid/view/View;
...
.method public static e(Landroid/view/View;Landroid/graphics/Bitmap;)Landroid/view/View;
    ...
    invoke-static {v0, p0, p1}, Lh/b/d/s/l;->c(Landroid/content/Context;Landroid/view/View;Landroid/graphics/Bitmap;)Landroid/view/View;
...
.method public static f(Landroid/view/View;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0}, Lh/b/d/s/l;->b(Landroid/view/View;)Z
    ...
    invoke-static {v0}, Lh/b/d/s/l;->a(Landroid/content/Context;)V
    ...
    :cond_1
    sget v1, Lh/b/d/s/l;->a:F

    invoke-static {v0, v1}, Lh/j/a;->F(Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;
