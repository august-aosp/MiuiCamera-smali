...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lh/j/a;->b:Ljava/lang/Object;
    ...
    sput-object v0, Lh/j/a;->c:[B

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    sput-object v0, Lh/j/a;->d:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Lh/j/a;->e:Landroid/graphics/Paint;
    ...
    sput-object v0, Lh/j/a;->f:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lh/j/a;->g:[Ljava/lang/String;
...
.method public static A(Landroid/graphics/Bitmap;I)I
    ...
    invoke-static {v0, v2, v1}, Lh/j/a;->Q(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method public static B(Landroid/content/Context;Landroid/net/Uri;)Landroid/graphics/BitmapFactory$Options;
    ...
    invoke-direct {v1, p0, p1}, Lh/m/a;-><init>(Landroid/content/Context;Landroid/net/Uri;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    :try_start_1
    invoke-static {v1}, Lh/j/a;->D(Lh/m/a;)Landroid/graphics/BitmapFactory$Options;

    move-result-object p0
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    invoke-virtual {v1}, Lh/m/a;->close()V
...
.method public static C(Ljava/lang/String;)Landroid/graphics/BitmapFactory$Options;
    ...
    invoke-direct {v1, p0}, Lh/m/a;-><init>(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
...
.method public static D(Lh/m/a;)Landroid/graphics/BitmapFactory$Options;
    .locals 2
...
.method private static E()Landroid/graphics/Canvas;
    ...
    sget-object v0, Lh/j/a;->d:Ljava/lang/ThreadLocal;
...
.method public static F(Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, v0}, Lh/j/a;->G(Landroid/graphics/Bitmap;FLandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
...
.method private static H(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0}, Lh/j/a;->f(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-static {p0}, Lh/j/a;->N(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Lh/e/d/l;->f(Ljava/lang/String;II)Ljava/lang/String;
...
.method public static I(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    :try_start_1
    invoke-static {v1}, Lh/j/a;->K(Lh/m/a;)Z
...
.method public static K(Lh/m/a;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    sget-object v0, Lh/j/a;->c:[B

    array-length v0, v0

    new-array v1, v0, [B

    invoke-virtual {p0, v1}, Lh/m/a;->read([B)I

    move-result p0

    if-lt p0, v0, :cond_0

    invoke-static {v1}, Lh/j/a;->L([B)Z
...
.method public static M(Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Bitmap;
    ...
    :cond_4
    :goto_1
    invoke-static {}, Lh/j/a;->E()Landroid/graphics/Canvas;
    ...
    :cond_8
    sget-object p1, Lh/j/a;->e:Landroid/graphics/Paint;
...
.method private static N(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    sget-object v4, Lh/j/a;->g:[Ljava/lang/String;
    ...
    invoke-static {v4}, Lh/j/a;->f(Ljava/lang/String;)Z
...
.method public static O(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1, v0}, Lh/j/a;->P(Landroid/graphics/Bitmap;Ljava/lang/String;Z)Z
...
.method public static Q(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1}, Lh/j/a;->R(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
...
.method public static b(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v0 .. v6}, Lh/j/a;->d(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Bitmap;
...
.method public static d(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Bitmap;
    ...
    :cond_4
    :goto_1
    invoke-static {p0, p2, v0, p5, p6}, Lh/j/a;->M(Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Bitmap;
...
.method private static e(Lh/m/a;I)I
    .locals 4

    if-lez p1, :cond_0

    invoke-static {p0}, Lh/j/a;->D(Lh/m/a;)Landroid/graphics/BitmapFactory$Options;
...
.method private static f(Ljava/lang/String;)Z
    ...
    sget-object v0, Lh/j/a;->f:Ljava/util/regex/Pattern;
...
.method public static h(Landroid/content/Context;Ljava/lang/String;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, p2, v0, v0}, Lh/j/a;->j(Landroid/content/Context;Ljava/lang/String;III)Landroid/graphics/Bitmap;
...
.method public static i(Landroid/content/Context;Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v0 .. v5}, Lh/j/a;->k(Landroid/content/Context;Ljava/lang/String;IIII)Landroid/graphics/Bitmap;
...
.method public static k(Landroid/content/Context;Ljava/lang/String;IIII)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1}, Lh/j/a;->H(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget v2, Lh/j/d$d;->word_photo_bg_light:I
    ...
    sget v2, Lh/j/d$d;->word_photo_bg_dark:I
    ...
    sget p3, Lh/j/d$a;->wordPhotoBackground:I

    invoke-static {p0, p3}, Lh/l/c/d;->i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    if-nez p3, :cond_7

    invoke-static {p0}, Lh/l/c/k;->h(Landroid/content/Context;)Z
    ...
    sget p4, Lh/j/d$b;->word_photo_color:I
    ...
    sget p4, Lh/j/d$b;->word_photo_color_dark:I
    ...
    :try_start_0
    sget p5, Lh/j/d$a;->wordPhotoTextColor:I

    invoke-static {p0, p5}, Lh/l/c/d;->e(Landroid/content/Context;I)I
...
.method public static l(Landroid/content/Context;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    sget v1, Lh/j/d$c;->contact_photo_width:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    invoke-static {p0, p1, v0}, Lh/j/a;->m(Landroid/content/Context;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
...
.method public static m(Landroid/content/Context;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    sget v0, Lh/j/d$d;->ic_contact_photo_fg:I

    invoke-virtual {p0, v0}, Landroid/content/res/Resources;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    sget v0, Lh/j/d$d;->ic_contact_photo_bg:I

    invoke-virtual {p0, v0}, Landroid/content/res/Resources;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v5

    sget v0, Lh/j/d$d;->ic_contact_photo_mask:I
    ...
    invoke-static/range {v1 .. v6}, Lh/j/a;->c(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;I)Landroid/graphics/Bitmap;
...
.method public static n(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Lh/j/a$b;)Landroid/graphics/Bitmap;
    .locals 16
    ...
    new-instance v2, Lh/j/a$b;

    invoke-direct {v2}, Lh/j/a$b;-><init>()V
    ...
    :goto_0
    iget-object v3, v2, Lh/j/a$b;->e:Landroid/graphics/Rect;
    ...
    invoke-static {v4, v5, v7}, Lh/j/a;->a(III)I
    ...
    invoke-static {v5, v7, v8}, Lh/j/a;->a(III)I
    ...
    invoke-static {v4, v8, v9}, Lh/j/a;->a(III)I
    ...
    invoke-static {v8, v9, v3}, Lh/j/a;->a(III)I
    ...
    iget v14, v2, Lh/j/a$b;->c:I

    invoke-static {v4, v13, v14}, Lh/j/a;->a(III)I

    move-result v13

    iput v13, v2, Lh/j/a$b;->c:I

    div-int/lit8 v13, v11, 0x2

    iget v14, v2, Lh/j/a$b;->a:I

    invoke-static {v4, v13, v14}, Lh/j/a;->a(III)I

    move-result v13

    iput v13, v2, Lh/j/a$b;->a:I

    div-int/lit8 v13, v12, 0x2

    iget v14, v2, Lh/j/a$b;->b:I

    invoke-static {v4, v13, v14}, Lh/j/a;->a(III)I

    move-result v13

    iput v13, v2, Lh/j/a$b;->b:I
    ...
    iget v0, v2, Lh/j/a$b;->a:I

    iget v1, v2, Lh/j/a$b;->c:I
    ...
    iget v1, v2, Lh/j/a$b;->a:I

    int-to-float v1, v1

    iget v2, v2, Lh/j/a$b;->b:I
...
.method public static o(Landroid/graphics/Bitmap;Lh/j/a$b;)Landroid/graphics/Bitmap;
    .locals 1

    if-eqz p0, :cond_0

    invoke-static {p0}, Lh/j/a;->g(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-static {p0, v0, p1}, Lh/j/a;->n(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Lh/j/a$b;)Landroid/graphics/Bitmap;
...
.method public static p(Landroid/content/Context;Landroid/net/Uri;IIZ)Landroid/graphics/Bitmap;
    ...
    :try_start_1
    invoke-static {v1, p2, p3, p4}, Lh/j/a;->v(Lh/m/a;IIZ)Landroid/graphics/Bitmap;
...
.method public static q(Landroid/content/Context;Landroid/net/Uri;IZ)Landroid/graphics/Bitmap;
    ...
    :try_start_1
    invoke-static {v1, p2, p3}, Lh/j/a;->w(Lh/m/a;IZ)Landroid/graphics/Bitmap;
...
.method public static r(Landroid/content/Context;Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
    ...
    :try_start_1
    invoke-static {v1, p0, p2}, Lh/j/a;->w(Lh/m/a;IZ)Landroid/graphics/Bitmap;
...
.method public static s(Ljava/lang/String;IIZ)Landroid/graphics/Bitmap;
    ...
    :try_start_1
    invoke-static {v1, p1, p2, p3}, Lh/j/a;->v(Lh/m/a;IIZ)Landroid/graphics/Bitmap;
...
.method public static t(Ljava/lang/String;IZ)Landroid/graphics/Bitmap;
    ...
    :try_start_1
    invoke-static {v1, p1, p2}, Lh/j/a;->w(Lh/m/a;IZ)Landroid/graphics/Bitmap;
...
.method public static u(Ljava/lang/String;Z)Landroid/graphics/Bitmap;
    ...
    :try_start_1
    invoke-static {v1, p0, p1}, Lh/j/a;->w(Lh/m/a;IZ)Landroid/graphics/Bitmap;
...
.method public static v(Lh/m/a;IIZ)Landroid/graphics/Bitmap;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_1
    invoke-static {p0, v0, p3}, Lh/j/a;->w(Lh/m/a;IZ)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, p2}, Lh/j/a;->Q(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method public static w(Lh/m/a;IZ)Landroid/graphics/Bitmap;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {p0, p1}, Lh/j/a;->e(Lh/m/a;I)I
    ...
    :try_start_0
    invoke-virtual {p0}, Lh/m/a;->reset()V
...
.method public static x(Landroid/content/Context;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1}, Lh/j/a;->g(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-static {p0, p1, v0, p2}, Lh/j/a;->y(Landroid/content/Context;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
...
.method public static y(Landroid/content/Context;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    :cond_2
    invoke-static {p0, p1, p2, p3}, Lh/j/a;->z(Landroid/content/Context;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
...
.method private static z(Landroid/content/Context;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v2, v3}, Lh/j/a;->Q(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    new-instance v3, Lh/j/a$a;

    invoke-direct {v3, p0}, Lh/j/a$a;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v2}, Lh/j/a;->S(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    :cond_4
    :goto_3
    sget-object v3, Lh/j/a;->b:Ljava/lang/Object;

    monitor-enter v3

    :try_start_1
    sget-object v4, Lh/j/a;->a:Landroid/renderscript/RenderScript;
    ...
    sput-object p0, Lh/j/a;->a:Landroid/renderscript/RenderScript;
    ...
    :cond_7
    sget-object v0, Lh/j/a;->a:Landroid/renderscript/RenderScript;
    ...
    sget-object v1, Lh/j/a;->a:Landroid/renderscript/RenderScript;
    ...
    invoke-static {p0, p2}, Lh/j/a;->R(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
