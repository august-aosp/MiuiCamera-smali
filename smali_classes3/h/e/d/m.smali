...
.method public static a(Landroid/content/Context;)Landroid/view/WindowMetrics;
    ...
    invoke-static {p0}, Lh/e/d/m;->i(Landroid/content/Context;)Landroid/view/WindowManager;
...
.method public static c(Landroid/content/Context;Landroid/graphics/Point;Landroid/graphics/Point;)V
    ...
    :cond_4
    invoke-static {p0}, Lh/e/d/g;->l(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_5

    invoke-static {p0}, Lh/e/d/m;->b(Landroid/content/Context;)Landroid/view/Display;
...
.method public static d(Landroid/content/Context;Landroid/graphics/Point;Landroid/graphics/Point;)V
    ...
    invoke-static {p0, p1, p2}, Lh/e/d/m;->c(Landroid/content/Context;Landroid/graphics/Point;Landroid/graphics/Point;)V
...
.method public static e(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {p0, v0}, Lh/e/d/m;->f(Landroid/content/Context;Landroid/graphics/Point;)V
...
.method public static g(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {p0}, Lh/e/d/m;->e(Landroid/content/Context;)Landroid/graphics/Point;
...
.method public static h(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lh/e/d/m;->j(Landroid/content/Context;)Landroid/graphics/Point;
...
.method public static j(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {p0, v0}, Lh/e/d/m;->l(Landroid/content/Context;Landroid/graphics/Point;)V
...
.method public static n(Landroid/view/View;)Landroid/graphics/Point;
    ...
    invoke-static {p0}, Lh/e/d/m;->k(Landroid/view/View;)Landroid/graphics/Point;
...
.method public static p(Landroid/content/Context;)Landroid/graphics/Rect;
    ...
    invoke-static {p0}, Lh/e/d/m;->a(Landroid/content/Context;)Landroid/view/WindowMetrics;
