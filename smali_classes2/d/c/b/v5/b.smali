.class public abstract Ld/c/b/v5/b;
...
.method public static d(IIIIIIIIZ)Ld/c/b/v5/f;
    .locals 8
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    new-instance v6, Ld/c/b/v5/f;

    invoke-direct {v6}, Ld/c/b/v5/f;-><init>()V

    invoke-virtual {v6, v7}, Ld/c/b/v5/f;->n(Lcom/xiaomi/protocol/IImageReaderParameterSets;)V

    move v0, p1

    invoke-virtual {v6, p1}, Ld/c/b/v5/f;->l(I)V
    ...
    invoke-static/range {v0 .. v5}, Ld/c/b/v5/b;->e(ZLd/c/b/v5/f;IIII)V

    return-object v6
.end method

.method private static e(ZLd/c/b/v5/f;IIII)V
    .locals 0
    ...
    invoke-virtual {p1, p0}, Ld/c/b/v5/f;->k(Landroid/media/ImageReader;)V
...
.method public a(Ld/c/b/v5/e;)V
    ...
    invoke-virtual {v0}, Ld/c/b/v5/d;->o()Z
    ...
    invoke-virtual {v0}, Ld/c/b/v5/d;->b()Ld/c/b/g4;
    ...
    invoke-virtual {p0}, Ld/c/b/v5/d;->e()I
    ...
    invoke-virtual {p0}, Ld/c/b/v5/f;->d()Lcom/xiaomi/protocol/IImageReaderParameterSets;
    ...
    invoke-virtual {p1, v0, p0}, Ld/c/b/v5/e;->a(ILd/c/b/v5/f;)V
...
.method public b(Ld/c/b/v5/e;Ld/c/a/r3;)V
    .locals 18
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {v3}, Ld/c/b/v5/d;->f()I
    ...
    invoke-virtual {v4}, Lcom/mi/config/DataItemFeature;->Ma()Z
    ...
    invoke-virtual/range {p2 .. p2}, Ld/c/a/r3;->j()Z
    ...
    invoke-virtual {v9}, Ld/c/b/v5/d;->b()Ld/c/b/g4;

    move-result-object v9

    invoke-virtual {v9}, Ld/c/b/g4;->p2()Z
    ...
    invoke-virtual/range {p2 .. p2}, Ld/c/a/r3;->i()I

    move-result v11

    invoke-virtual/range {p2 .. p2}, Ld/c/a/r3;->c()I

    move-result v12

    iget-object v4, v0, Ld/c/a/q6/v8/c;->mParam:Ljava/lang/Object;

    check-cast v4, Ld/c/b/v5/d;

    invoke-virtual {v4}, Ld/c/b/v5/d;->e()I
    ...
    invoke-virtual {v1, v5, v4}, Ld/c/b/v5/e;->a(ILd/c/b/v5/f;)V
    ...
    invoke-virtual {v4}, Ld/c/b/v5/d;->b()Ld/c/b/g4;

    move-result-object v4

    invoke-virtual {v4}, Ld/c/b/g4;->p2()Z
    ...
    iget-object v2, v0, Ld/c/a/q6/v8/c;->mParam:Ljava/lang/Object;

    check-cast v2, Ld/c/b/v5/d;

    invoke-virtual {v2}, Ld/c/b/v5/d;->e()I
    ...
    invoke-virtual {v1, v4, v2}, Ld/c/b/v5/e;->a(ILd/c/b/v5/f;)V
    ...
    invoke-virtual {v2}, Ld/c/b/g4;->M0()Ld/c/a/r3;
    ...
    invoke-virtual {v1, v6, v4}, Ld/c/b/v5/e;->a(ILd/c/b/v5/f;)V
    ...
    invoke-virtual {v2}, Ld/c/b/g4;->e1()Ld/c/a/r3;
    ...
    iget-object v0, v0, Ld/c/a/q6/v8/c;->mParam:Ljava/lang/Object;

    check-cast v0, Ld/c/b/v5/d;

    invoke-virtual {v0}, Ld/c/b/v5/d;->e()I
    ...
    invoke-virtual {v1, v3, v0}, Ld/c/b/v5/e;->a(ILd/c/b/v5/f;)V
    ...
    invoke-virtual {v1, v5, v0}, Ld/c/b/v5/e;->a(ILd/c/b/v5/f;)V
...
.method public c(Ld/c/b/v5/e;)V
    ...
    invoke-static/range {v1 .. v9}, Ld/c/b/v5/b;->d(IIIIIIIIZ)Ld/c/b/v5/f;

    move-result-object p0

    const/4 v1, 0x6

    invoke-virtual {p1, v1, p0}, Ld/c/b/v5/e;->a(ILd/c/b/v5/f;)V
...
.method public f(Ld/c/b/v5/e;)V
    ...
    iget-object v8, p0, Ld/c/a/q6/v8/c;->mParam:Ljava/lang/Object;

    check-cast v8, Ld/c/b/v5/d;

    invoke-virtual {v8}, Ld/c/b/v5/d;->e()I
    ...
    invoke-static/range {v3 .. v11}, Ld/c/b/v5/b;->d(IIIIIIIIZ)Ld/c/b/v5/f;

    move-result-object v3

    invoke-virtual {p1, v4, v3}, Ld/c/b/v5/e;->a(ILd/c/b/v5/f;)V
    ...
    invoke-virtual {p1, v3, p0}, Ld/c/b/v5/e;->a(ILd/c/b/v5/f;)V
